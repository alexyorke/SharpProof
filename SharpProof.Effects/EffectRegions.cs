...
public readonly record struct EffectRegionId : IComparable<EffectRegionId>
{
    ...
    public static EffectRegionId Parameter(int ordinal)
    {
        return new(EffectRegionKind.Parameter, ordinal);
    }

    public static EffectRegionId Captured(int ordinal)
    {
        return new(EffectRegionKind.Captured, ordinal);
    }

    public static EffectRegionId Static(int ordinal = 0)
    {
        return new(EffectRegionKind.Static, ordinal);
    }

    public static EffectRegionId Fresh(int ordinal)
    {
        return new(EffectRegionKind.Fresh, ordinal);
    }

    public EffectRegionKind Kind
    {
        get;
    }
    public int Ordinal
    ...
    {
        return Kind.CompareTo(other.Kind) is var kind && kind != 0 ? kind : Ordinal.CompareTo(other.Ordinal);
    }
}
...
public readonly struct EffectRegionSet : IEquatable<EffectRegionSet>
{
    ...
    private EffectRegionSet(ImmutableArray<EffectRegionId> regions)
    {
        _regions = regions;
    }
    ...
    {
        return IsUnknown || Regions.BinarySearch(region) >= 0;
    }

    public bool IsSubsetOf(EffectRegionSet other)
    {
        if (IsEmpty || other.IsUnknown)
        {
            return true;
        }
    ...
    public bool Equals(EffectRegionSet other)
    {
    ...
    {
        return obj is EffectRegionSet other && Equals(other);
    }

    public override int GetHashCode()
    {
        return Regions.Aggregate(17, static (hash, region) => unchecked(hash * 31 + region.GetHashCode()));
    }

    public static bool operator ==(EffectRegionSet left, EffectRegionSet right)
    {
