...
internal static class EffectSummaryOperations {
    ...
    internal static EffectSummary JoinFrom(
        EffectSummary result,
        IEnumerable<EffectSummary> summaries) {
    ...
    internal static EffectSummary DirectCall() =>
        Create(uncertainty: EffectUncertainty.DirectCall);
    ...
    internal static EffectSummary MayDiverge() =>
        Create(termination: EffectTermination.MayDiverge);
    ...
    internal static EffectSummary Remap(
        ...
        return new EffectSummary(
            ...
            summary.Completeness, summary.Uncertainty);
    }
