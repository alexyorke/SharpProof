...
public class TestClass
{
    ...
    public void TestMethod(int[] values, Comparison<int> comparison)
    {
        ...
        [Test]
        public async Task Ps0002_DoubleDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using PurelySharp.Attributes;
...
public sealed class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        resource.Dispose();
            ...
            Assert.That(diagnostic.Properties[PurelySharpDiagnostics.ImpurityCategoryProperty], Is.EqualTo("resource_double_dispose"));
            Assert.That(diagnostic.Properties[PurelySharpDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            ...
            Assert.That(diagnostic.Properties[PurelySharpDiagnostics.ImpuritySymbolProperty], Does.Contain("PureDisposable.Dispose"));
        }

        [Test]
        public async Task Ps0002_UseAfterDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using PurelySharp.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Ps0002_UseAfterUsingStatement_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using PurelySharp.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        _value = 1;
            ...
            Assert.That(diagnostic.Properties[PurelySharpDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("analyzer.mutation.caller-visible"));
