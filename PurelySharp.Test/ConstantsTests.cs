...
public static class DecimalNegateCatalogSignatureSamples
{
    public static int Sample(decimal value)
    {
        ...
        {
            var globalOptions = additionalFiles.IsDefaultOrEmpty
                ? ImmutableDictionary<string, string>.Empty
                : ImmutableDictionary<string, string>.Empty.Add("purelysharp_enable_effect_summary_json", "true");
