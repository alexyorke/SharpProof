        ...
        return values.GetEnumerator();
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    ...
                    "Synthetic.Array.GetEnumerator.PurelySharp.EffectSummary.json",
    ...
    public static SortedDictionary<int, string>.ValueCollection SortedValues(SortedDictionary<int, string> values) => values.Values;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    ...
                    "Synthetic.Dictionary.Keys.PurelySharp.EffectSummary.json",
                ...
                (
                    typeof(Dictionary<int, string>).Assembly.Location,
                    "Synthetic.Dictionary.Values.PurelySharp.EffectSummary.json",
                ...
                (
                    ...
                    "Synthetic.SortedDictionary.Keys.PurelySharp.EffectSummary.json",
                ...
                (
                    typeof(SortedDictionary<int, string>).Assembly.Location,
                    "Synthetic.SortedDictionary.Values.PurelySharp.EffectSummary.json",
        ...
        return values.GetKey(index);
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    ...
                    "Synthetic.Hashtable.ContainsKey.PurelySharp.EffectSummary.json",
                ...
                (
                    ...
                    "Synthetic.CompareInfo.Compare.PurelySharp.EffectSummary.json",
                ...
                (
                    ...
                    "Synthetic.SortedList.GetKey.PurelySharp.EffectSummary.json",
...
public static class TypeMetadataCatalogSignatureSamples
{
    ...
    public static Type? ReflectedType(Type type) => type.ReflectedType;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    typeof(Type).Assembly.Location,
                    "Synthetic.Type.IsAbstract.PurelySharp.EffectSummary.json",
                ...
                (
                    typeof(Type).Assembly.Location,
                    "Synthetic.Type.IsClass.PurelySharp.EffectSummary.json",
                ...
                (
                    typeof(Type).Assembly.Location,
                    "Synthetic.Type.IsValueType.PurelySharp.EffectSummary.json",
        ...
        return culture.Name;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    ...
                    "Synthetic.CultureInfo.Name.PurelySharp.EffectSummary.json",
    ...
    public static Assembly Sample(Type type)
    {
        return type.Assembly;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    typeof(Type).Assembly.Location,
                    "Synthetic.Type.Assembly.PurelySharp.EffectSummary.json",
        ...
        return ConfigurationManager.AppSettings[""MyKey""];
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    ...
                    "Synthetic.ConfigurationManager.AppSettings.PurelySharp.EffectSummary.json",
    ...
    public static ConnectionStringSettingsCollection Sample()
    {
        return ConfigurationManager.ConnectionStrings;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    typeof(ConfigurationManager).Assembly.Location,
                    "Synthetic.ConfigurationManager.ConnectionStrings.PurelySharp.EffectSummary.json",
