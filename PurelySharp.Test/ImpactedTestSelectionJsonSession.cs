...
internal sealed class ImpactedTestSelectionJsonSession : IAsyncDisposable
{
    ...
    {
        var hostPath = Path.Combine(repositoryRoot, "PurelySharp.Test", "ImpactedTestSelectionJsonHost.ps1");
        var selectorPath = Path.Combine(repositoryRoot, "scripts", "Invoke-PurelySharpImpactedTests.ps1");
