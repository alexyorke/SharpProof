...
""";
            ...
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=effect_summary:" + expectedSourceChain));
            ...
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=effect_summary:" + expectedSourceChain));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("SummaryBoundary.Outer"));
        }
...
""";
        ...
        [Test]
        public async Task Sp0010_EffectSummary_TransitiveThrownExceptionEdges_WithSchemaFields_MatchLegacyDiagnosticProperties()
        {
            const string boundarySource = """
using System;
...
""";
            ...
            AssertMatchingExceptionDiagnostics(legacyDiagnostics, edgeDiagnostics, SharpProofDiagnostics.ExceptionSummaryId);
            AssertMatchingExceptionDiagnostics(legacyDiagnostics, edgeDiagnostics, SharpProofDiagnostics.UncaughtExceptionSiteId);
        }
...
""",
            ...
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.FormatException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
        }
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_WithTrustedGeneratedImpureClassification_AffineContradictoryGuard_SuppressesImpurity()
        {
            const string boundarySource = """
public static class ImpureBoundary
{
...
""",
            ...
            var diagnostic = diagnostics.Single(d => d.Id == SharpProofDiagnostics.PurityNotVerifiedId);
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.Not.EqualTo("generated_purity_summary"));
        }
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_WithTrustedGeneratedPureConstructorClassification_SuppressesUnknownExternalCall()
        {
            const string boundarySource = """
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_ConfigKnownImpureConstructor_OverridesGeneratedPureConstructorClassification()
        {
            const string boundarySource = """
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_ConfigKnownImpureInterpolationToString_OverridesGeneratedPureFormattingClassification()
        {
            const string boundarySource = """
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_WithTrustedGeneratedPureBinaryOperatorClassification_SuppressesUnknownExternalCall()
        {
            const string boundarySource = """
...
""",
        ...
        [Test]
        public async Task Sp0002_EffectSummary_WithTrustedGeneratedPureConversionClassification_SuppressesUnknownExternalCall()
        {
            const string boundarySource = """
...
""",
        ...
        public void ExceptionSummaryCatalog_RepeatedMetadataQueriesReuseAssemblyIdentityCache()
        {
            ...
            var catalogType = typeof(SharpProofAnalyzer).Assembly.GetType("SharpProof.Analyzer.ExceptionSummaryCatalog", throwOnError: true)!;
            ...
            try
            {
                ...
                var firstExceptions = ((System.Collections.IEnumerable)firstArgs[2]!)
                    .Cast<object>()
                ...
                var secondExceptions = ((System.Collections.IEnumerable)secondArgs[2]!)
                    .Cast<object>()
                    .Select(info => (string)info.GetType().GetProperty("ExceptionType")!.GetValue(info)!)
                    .ToArray();
...
"""))),
            ...
            var facts = ((System.Collections.IEnumerable)args[2]!)
                ...
                .SelectMany(info =>
                {
                    ...
                    var sources = ((System.Collections.IEnumerable)infoType.GetProperty("Sources")!.GetValue(info)!)
                        .Cast<string>()
                        .Select(source => (ExceptionType: exceptionType, SourcePath: source, CalleeExactSymbolKey: (string?)null, Depth: (int?)null));
                    var edges = ((System.Collections.IEnumerable)infoType.GetProperty("Edges")!.GetValue(info)!)
                        .Cast<object>()
                        .Select(edge =>
                        {
            ...
            {
                ("System.ArgumentException", "throw new System.ArgumentException()", null, (int?)null),
                ("System.ArgumentException", "throw new System.ArgumentException()", null, (int?)0),
                ("System.InvalidOperationException", "TestMethod() -> Helper()", null, (int?)null),
