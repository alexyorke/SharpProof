...
""";
            ...
            var expected = new[] {
                ...
                VerifyCS.Diagnostic(SharpProofDiagnostics.PurityNotVerifiedRule).WithSpan(16, 17, 16, 29).WithArguments("UpdatePerson"),

                VerifyCS.Diagnostic(SharpProofDiagnostics.MissingEnforcePureAttributeId).WithSpan(9, 19, 9, 23).WithArguments("get_Name"),
                VerifyCS.Diagnostic(SharpProofDiagnostics.MissingEnforcePureAttributeId).WithSpan(10, 16, 10, 19).WithArguments("get_Age"),
            };
