...
internal class ProofCoreZ3SmokeTests {
    ...
    public void RegexTranslationValidator_ClassifiesOversizedPatternBeforeParsing()
        => Assert.That(Z3RegexTranslationValidator.Validate(new string('a', 257), RegexOptions.None),
        Is.EqualTo(RegexTranslationFallback.PatternTooLong));
    private static void AssertSatisfiability(Feasibility expected, IEnumerable<SmtFormula> pathConditions, TimeSpan? timeout = null) {
    ...
    private static void AssertImplication(Feasibility expected, IEnumerable<SmtFormula> pathConditions, SmtFormula conclusion,
    ...
    private static IEnumerable<TestCaseData> RegexSatisfiabilityCases() {
        ...
        yield return CreateRegexCase("SmtSolver_UnsupportedRegexOptionsWithoutConcreteInput_ReturnsUnknown", Feasibility.Unknown,
            @"\Aab\z", options: RegexOptions.IgnoreCase);
        yield return CreateRegexCase("SmtSolver_UnsupportedRegexOptionsConcreteMismatchUsesDotNetOptions", Feasibility.Unsatisfiable,
            @"\Aab\z", RegexConstraint.Equal, "CD", options: RegexOptions.IgnoreCase);
        yield return CreateRegexCase("SmtSolver_MultilineCaretAnchorWithoutConcreteInput_ReturnsUnknown", Feasibility.Unknown, "^AB",
            options: RegexOptions.Multiline);
        yield return CreateRegexCase("SmtSolver_LeadingContiguousAnchorRegexAcceptsInitialMatch", Feasibility.Satisfiable, @"\GAB",
            RegexConstraint.StartsWith, "AB");
        yield return CreateRegexCase("SmtSolver_LeadingContiguousAnchorRegexContradictsLaterMatch", Feasibility.Unsatisfiable, @"\GAB",
            RegexConstraint.StartsWith, "XAB");
        yield return CreateRegexCase("SmtSolver_InternalContiguousAnchorRegexWithoutConcreteInput_ReturnsUnknown", Feasibility.Unknown,
            @"\AA\GB\z");
        yield return CreateRegexCase("SmtSolver_CultureInvariantIgnoreCaseRegexAcceptsCaseVariantLiteral", Feasibility.Satisfiable,
            @"\Aab\z", RegexConstraint.Equal, "AB", options: RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
        yield return CreateRegexCase("SmtSolver_CultureInvariantIgnoreCaseCharClassAcceptsUppercaseVariant", Feasibility.Satisfiable,
            @"\A[a-c]\z", RegexConstraint.Equal, "B", options: RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
        yield return CreateRegexCase("SmtSolver_InvalidRegexCategoryWithoutConcreteInput_ReturnsUnknown", Feasibility.Unknown,
        ...
        yield return CreateRegexCase("SmtSolver_IgnorePatternWhitespaceGroupKeepsEscapedSpaceLiteral", Feasibility.Unsatisfiable,
            "\\A(?x:A\\ B)\\z", RegexConstraint.NotEqual, "A B");
        yield return CreateRegexCase("SmtSolver_DefaultDotRejectsNewline", Feasibility.Unsatisfiable, @"\A.\z", RegexConstraint.Equal,
            "\n");
        yield return CreateRegexCase("SmtSolver_InlineSinglelineDotAllowsNewline", Feasibility.Satisfiable, @"\A(?s:.)\z",
            RegexConstraint.Equal, "\n");
        yield return CreateRegexCase("SmtSolver_ScopedSinglelineDisableDotRejectsNewline", Feasibility.Unsatisfiable,
            @"\A(?s:A(?-s:.)C)\z", RegexConstraint.Equal, "A\nC");
        yield return CreateRegexCase("SmtSolver_InlineIgnoreCaseOptionGroupAffectsFollowingLiterals", Feasibility.Satisfiable,
        ...
        yield return CreateRegexCase("SmtSolver_InlineSinglelineDisableMakesFollowingDotRejectsNewline", Feasibility.Unsatisfiable,
            @"\A(?s).(?-s).\z", RegexConstraint.Equal, "\n\n");
        yield return CreateRegexCase("SmtSolver_InlineRegexCommentBeforeQuantifierPreservesPreviousAtom", Feasibility.Satisfiable,
        ...
        yield return CreateRegexCase("SmtSolver_LeadingBracketRegexClassLiteralContradictsPrefix", Feasibility.Unsatisfiable, @"\A[]]\z",
            RegexConstraint.StartsWith, "A");
        yield return CreateRegexCase("SmtSolver_CharacterClassSubtractionRejectsExcludedLiteral", Feasibility.Unsatisfiable,
            @"\A[a-z-[aeiou]]\z", RegexConstraint.Equal, "a");
        yield return CreateRegexCase("SmtSolver_CharacterClassSubtractionAllowsRemainingLiteral", Feasibility.Satisfiable,
            @"\A[a-z-[aeiou]]\z", RegexConstraint.Equal, "b");
        yield return CreateRegexCase("SmtSolver_ControlCharacterEscapeAllowsExpectedCharacter", Feasibility.Satisfiable, @"\A\cA\z",
            RegexConstraint.StartsWithAndLength, "\u0001", 1);
        yield return CreateRegexCase("SmtSolver_ControlCharacterClassEscapeContradictsDifferentCharacter", Feasibility.Unsatisfiable,
            @"\A[\cA]\z", RegexConstraint.StartsWithAndLength, "\u0002", 1);
        yield return CreateRegexCase("SmtSolver_OctalRegexEscapeImpliesSpaceLiteral", Feasibility.Unsatisfiable, @"\A\040\z",
            RegexConstraint.NotEqual, " ");
        yield return CreateRegexCase("SmtSolver_OctalRegexEscapeConsumesAtMostTwoFollowingDigits", Feasibility.Unsatisfiable, @"\A\0408\z",
            RegexConstraint.NotEqual, " 8");
        yield return CreateRegexCase("SmtSolver_OctalRegexClassEscapeContradictsDifferentCharacter", Feasibility.Unsatisfiable,
            @"\A[\040]\z", RegexConstraint.StartsWith, "A");
        yield return CreateRegexCase("SmtSolver_PositiveLookaheadRegexContradictsImpossibleSuffix", Feasibility.Unsatisfiable,
            @"\A(?=AB)A.\z", RegexConstraint.Equal, "AC");
        yield return CreateRegexCase("SmtSolver_PositiveLookaheadRegexAcceptsMatchingSuffix", Feasibility.Satisfiable, @"\A(?=AB)A.\z",
            RegexConstraint.Equal, "AB");
        yield return CreateRegexCase("SmtSolver_NegativeLookaheadRegexRejectsExcludedSuffix", Feasibility.Unsatisfiable, @"\A(?!AB)A.\z",
            RegexConstraint.Equal, "AB");
        yield return CreateRegexCase("SmtSolver_NegativeLookaheadRegexAcceptsDifferentSuffix", Feasibility.Satisfiable, @"\A(?!AB)A.\z",
            RegexConstraint.Equal, "AC");
        yield return CreateRegexCase("SmtSolver_LookaheadWithoutConsumingSuffix_ReturnsUnknown", Feasibility.Unknown, @"\AA(?=B)");
        yield return CreateRegexCase("SmtSolver_PositiveLookbehindRegexContradictsImpossiblePrefix", Feasibility.Unsatisfiable,
            @"\A[AB]{2}(?<=AB)C\z", RegexConstraint.Equal, "AAC");
        yield return CreateRegexCase("SmtSolver_PositiveLookbehindRegexAcceptsMatchingPrefix", Feasibility.Satisfiable,
            @"\A[AB]{2}(?<=AB)C\z", RegexConstraint.Equal, "ABC");
        yield return CreateRegexCase("SmtSolver_NegativeLookbehindRegexRejectsExcludedPrefix", Feasibility.Unsatisfiable,
            @"\A[AB]{2}(?<!AB)C\z", RegexConstraint.Equal, "ABC");
        yield return CreateRegexCase("SmtSolver_NegativeLookbehindRegexAcceptsDifferentPrefix", Feasibility.Satisfiable,
            @"\A[AB]{2}(?<!AB)C\z", RegexConstraint.Equal, "AAC");
        yield return CreateRegexCase("SmtSolver_LookbehindWithoutParsedPrefix_ReturnsUnknown", Feasibility.Unknown, @"\A(?<=A)B\z");
        yield return CreateRegexCase("SmtSolver_AtomicGroupRegexContradictsWrongPrefix", Feasibility.Unsatisfiable, @"\A(?>A*)A\z",
            RegexConstraint.StartsWith, "B");
        yield return CreateRegexCase("SmtSolver_AtomicGroupApproximateSatisfiableResult_ReturnsUnknown", Feasibility.Unknown,
            @"\A(?>A*)A\z", RegexConstraint.StartsWith, "A");
        yield return CreateRegexCase("SmtSolver_NegatedApproximateRegexWithLength_ReturnsUnknown", Feasibility.Unknown, @"\A(?>A*)A\z",
            RegexConstraint.NegatedMatchAndLength, length: 1);
        yield return CreateRegexCase("SmtSolver_WordBoundaryRegexSatisfiableResult_IsUnknown", Feasibility.Unknown, @"\A\bA\z",
            RegexConstraint.StartsWith, "A");
        yield return CreateRegexCase("SmtSolver_WordBoundaryBetweenWordsIsUnsatisfiable", Feasibility.Unsatisfiable, @"\AA\bB\z",
            RegexConstraint.StartsWith, "AB");
        yield return CreateRegexCase("SmtSolver_NonWordBoundaryBetweenWordsIsUnknown", Feasibility.Unknown, @"\AA\BB\z",
            RegexConstraint.StartsWith, "AB");
        yield return CreateRegexCase("SmtSolver_NonWordBoundaryBetweenWordAndPunctuationIsUnsatisfiable", Feasibility.Unsatisfiable,
            @"\AA\B!\z", RegexConstraint.StartsWith, "A!");
        yield return CreateRegexCase("SmtSolver_DigitRegexContradictsNonDigitPrefix", Feasibility.Unsatisfiable, @"\A\d\z",
            RegexConstraint.StartsWith, "A");
        yield return CreateRegexCase("SmtSolver_NonDigitRegexContradictsSingleDigitPrefix", Feasibility.Unsatisfiable, @"\A\D\z",
            RegexConstraint.StartsWithAndLength, "5", 1);
        yield return CreateRegexCase("SmtSolver_NegatedDigitClassContradictsSingleDigitPrefix", Feasibility.Unsatisfiable, @"\A[^\d]\z",
            RegexConstraint.StartsWithAndLength, "5", 1);
        yield return CreateRegexCase("SmtSolver_WhitespaceRegexContradictsNonWhitespacePrefix", Feasibility.Unsatisfiable, @"\A\s\z",
            RegexConstraint.StartsWith, "A", extendedTimeout: true);
        yield return CreateRegexCase("SmtSolver_NonWhitespaceRegexContradictsNewlinePrefix", Feasibility.Unsatisfiable, @"\A\S\z",
            RegexConstraint.StartsWithAndLength, "\n", 1, extendedTimeout: true);
        yield return CreateRegexCase("SmtSolver_WordRegexContradictsPunctuationPrefix", Feasibility.Unsatisfiable, @"\A\w\z",
            RegexConstraint.StartsWith, "!", extendedTimeout: true);
        yield return CreateRegexCase("SmtSolver_NonWordRegexContradictsUnderscorePrefix", Feasibility.Unsatisfiable, @"\A\W\z",
            RegexConstraint.StartsWithAndLength, "_", 1, extendedTimeout: true);
        yield return CreateRegexCase("SmtSolver_UnicodeCategoryRegexContradictsLetterPrefix", Feasibility.Unsatisfiable, @"\A\p{P}\z",
            RegexConstraint.StartsWith, "A", extendedTimeout: true);
    }
    private static IEnumerable<TestCaseData> RegexImplicationCases() {
        yield return CreateRegexImplicationCase("SmtSolver_MultilineOptionStrictAnchorsRemainExact", @"\AAB\z", RegexConclusion.Equal,
            "AB", options: RegexOptions.Multiline);
        yield return CreateRegexImplicationCase("SmtSolver_CultureInvariantIgnoreCaseRegexImpliesLiteralLength", @"\Aab\z",
            RegexConclusion.LengthEqual, length: 2, options: RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
        yield return CreateRegexImplicationCase("SmtSolver_FinalNewlineRegexAnchorImpliesBoundedLength", @"\AAB\Z",
            RegexConclusion.LengthAtMost, length: 3);
        yield return CreateRegexImplicationCase("SmtSolver_InlineOptionBeforeStrictAnchorsImpliesLiteralLength", @"(?i)\Aab\z",
    ...
    public void SmtSolver_RegexSatisfiabilityMatrix(RegexCase testCase) {
        ...
        AssertSatisfiability(testCase.Expected, formulas, testCase.ExtendedTimeout ? TimeSpan.FromMilliseconds(250) : null);
    }
    ...
    public void SmtSolver_RegexImplicationMatrix(RegexImplicationCase testCase) {
        ...
        var conclusion = testCase.Conclusion switch {
            ...
            RegexConclusion.LengthEqual => Compare(SmtBinaryOperator.Equal, new SmtStringLengthTerm(text), testCase.Length),
            RegexConclusion.LengthAtMost => Compare(SmtBinaryOperator.LessThanOrEqual, new SmtStringLengthTerm(text), testCase.Length),
            _ => throw new ArgumentOutOfRangeException()
        };
        AssertImplication(Feasibility.Unsatisfiable, [new SmtRegexMatchFormula(text, testCase.Pattern, testCase.Options)], conclusion);
    }
    ...
    private static IEnumerable<TestCaseData> SolverCases() {
        yield return CreateSolverCase("SmtSolver_NonPositiveTimeout_ReturnsUnknown", [Equal(Int("x"), Integer(1))], Feasibility.Unknown,
            zeroTimeout: true);
        yield return CreateSolverCase("SmtSolver_MismatchedEqualitySorts_ReturnsUnknown", [Equal(Int("mixed"), String("mixed"))],
            Feasibility.Unknown);
        yield return CreateSolverCase("SmtSolver_ConditionalIntegerTermHonorsSelectedBranch",
            [Bool("useFirstBranch"), NotEqual(Conditional(Bool("useFirstBranch"), Integer(1), Integer(2), SmtValueKind.Int), Integer(1))],
                Feasibility.Unsatisfiable);
        ...
        yield return CreateSolverCase("SmtSolver_StringPrefixSuffixAndLengthFactsCombine",
            [StartsWith(String("text"), Text("AB")), EndsWith(String("text"), Text("CD")), Equal(Length(String("text")), Integer(3))],
                Feasibility.Unsatisfiable);
        yield return CreateSolverCase("SmtSolver_StringContainsAndConcatFactsCombine",
            [Equal(String("left"), Text("A")), Equal(String("right"), Text("B")), Not(Contains(Concat(String("left"), String("right")),
                Text("AB")))], Feasibility.Unsatisfiable);
        ...
        yield return CreateSolverCase("SmtSolver_StringContainsWithExactLengthInfersValue",
            [Equal(Length(String("text")), Integer(2)), Contains(String("text"), Text("AB")), NotEqual(String("text"), Text("AB"))],
                Feasibility.Unsatisfiable);
        ...
        yield return CreateSolverCase("SmtSolver_RemainderWithRelationalNonZeroGuard_RemainsUsable",
            [GreaterThan(Int("divisor"), Integer(0)), Equal(Int("divisor"), Integer(2)), NotEqual(Remainder(Integer(5), Int("divisor")),
                Integer(1))], Feasibility.Unsatisfiable);
        yield return CreateSolverCase("SmtSolver_NegativeDividendDivision_UsesCSharpTruncation",
            [GreaterThan(Int("dividend"), Integer(-2)), LessThan(Int("dividend"), Integer(0)), Equal(Divide(Int("dividend"), Integer(2)),
                Integer(0))], Feasibility.Satisfiable);
        yield return CreateSolverCase("SmtSolver_NegativeDividendRemainder_UsesCSharpSign",
            [GreaterThan(Int("dividend"), Integer(-2)), LessThan(Int("dividend"), Integer(0)), Equal(Remainder(Int("dividend"),
                Integer(2)), Integer(-1))], Feasibility.Satisfiable);
        yield return CreateSolverCase("SmtSolver_NegativeDivisorDivision_UsesCSharpTruncation",
            [GreaterThan(Int("divisor"), Integer(-3)), LessThan(Int("divisor"), Integer(0)), Equal(Divide(Integer(3), Int("divisor")),
                Integer(-1))], Feasibility.Satisfiable);
        yield return CreateSolverCase("SmtSolver_NonNegativeRemainderWithPositiveDivisor_ProvesRange",
            [GreaterThanOrEqual(Int("dividend"), Integer(0)), GreaterThan(Int("divisor"), Integer(0)),
                Or(LessThan(Remainder(Int("dividend"), Int("divisor")), Integer(0)), GreaterThanOrEqual(Remainder(Int("dividend"),
                Int("divisor")), Int("divisor")))], Feasibility.Unsatisfiable);
        yield return CreateSolverCase("SmtSolver_SelectedConditionalSkipsUnsafeUnselectedIntegerBranch",
            [Bool("useSafeBranch"), NotEqual(Conditional(Bool("useSafeBranch"), Integer(7), Divide(Integer(1), Integer(0)),
                SmtValueKind.Int), Integer(7))], Feasibility.Unsatisfiable);
        yield return CreateSolverCase("SmtSolver_NegatedComparisonGuardKeepsDivisionUsable",
            [Not(LessThanOrEqual(Int("divisor"), Integer(0))), NotEqual(Divide(Integer(10), Int("divisor")), Integer(999))],
                Feasibility.Satisfiable);
        yield return CreateSolverCase("SmtSolver_AffineRangeGuardKeepsDerivedDivisorUsable",
            [GreaterThan(Int("x"), Integer(1)), Equal(Divide(Integer(10), Subtract(Int("x"), Integer(1))), Integer(10))],
                Feasibility.Satisfiable);
        ...
        yield return CreateSolverCase("SmtSolver_ExactLengthPrefixSuffixOverlapInfersString",
            [StartsWith(String("text"), Text("AB")), EndsWith(String("text"), Text("BC")), Equal(Length(String("text")), Integer(3)),
                NotEqual(String("text"), Text("ABC"))], Feasibility.Unsatisfiable);
    ...
    private static TestCaseData CreateSolverCase(string name, SmtFormula[] conditions, Feasibility expected, SmtFormula? conclusion = null,
        bool zeroTimeout = false) =>
