...
public sealed class ContractFixture
{
    ...
    public static void Reads() {
        ...
        var flowValue = root.DescendantNodes()
            ...
            .Expression;
        Assert.That( NullableFlowFacts.GetExpressionState(flowValue, semanticModel, CancellationToken.None), Is.EqualTo(NullableFlowFactState.NotNull));
        ...
        Assert.That( NullableFlowFacts.GetExpressionState(invocations["Always"], semanticModel, CancellationToken.None), Is.EqualTo(NullableFlowFactState.NotNull));
        Assert.That( NullableFlowFacts.GetExpressionState(invocations["Maybe"], semanticModel, CancellationToken.None), Is.EqualTo(NullableFlowFactState.MaybeNull));
    }
