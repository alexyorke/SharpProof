...
public sealed class MethodEffectsTests {
    ...
    private static IEnumerable<TestCaseData> EffectCases() {
        ...
        yield return Effect("MathAsinIsPureAndAllocationFree", """
            ...
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathFAsinIsPureAndAllocationFree", """
            class C {
                static float M(float value) => System.MathF.Asin(value);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathAcosIsPureAndAllocationFree", """
            class C {
                static double M(double value) => System.Math.Acos(value);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathFAcosIsPureAndAllocationFree", """
            class C {
                static float M(float value) => System.MathF.Acos(value);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathAtanIsPureAndAllocationFree", """
            class C {
                static double M(double value) => System.Math.Atan(value);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathFAtanIsPureAndAllocationFree", """
            class C {
                static float M(float value) => System.MathF.Atan(value);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
            forbidden: SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState |
                       SharpProofEffect.Allocates | SharpProofEffect.Throws | SharpProofEffect.Unknown);
        yield return Effect("MathAtan2IsPureAndAllocationFree", """
            class C {
                static double M(double y, double x) => System.Math.Atan2(y, x);
            }
            """, 2,
            purity: SharpProofVerdict.Proven,
            allocationFree: SharpProofVerdict.Proven,
