...
public sealed class MethodEffectsTests {
    ...
    [Test]
    public void EarlierDefaultDoesNotPreemptMatchingConstantCase() {
        var result = Analyze("""
            class C {
                static int state;
                static void M() {
    ...
    [Test]
    public void NonNullCoalesceAssignmentSkipsRightOperand() {
        var result = Analyze("""
            class C {
                static int state;
                static string Mutate() { state++; return "fallback"; }
    ...
    [Test]
    public void NullGuardSkipsCoalesceAssignmentFallback() {
        var result = Analyze("""
            class C {
                static int state;
                static string Mutate() { state++; return "unused"; }
    ...
    [Test]
    public void CollectionSpreadUsesCompilerSelectedExtensionEnumerator() {
        var result = Analyze("""
            static class Globals { public static int Count; }
            class Base { }
            sealed class Derived : Base { }
    ...
    [Test]
    public void HelperMutationMapsOnlyMutatedArgument() {
        var result = Analyze("""
            sealed class Box { public int Value; }
            class C {
    ...
    [Test]
    public void LocalFunctionMutationMapsOnlyMutatedArgument() {
        var result = Analyze("""
            sealed class Box { public int Value; }
            class C {
                static void M(Box external) {
    ...
    [Test]
    public void FreshCapturingLocalFunctionMapsMutatedArgument() {
        var result = Analyze("""
            sealed class Box { public int Value; }
            class C {
                static void M(Box external) {
    ...
    [Test]
    public void ArgumentCapturingLocalFunctionSeparatesCaptureReadFromParameterWrite() {
        var result = Analyze("""
            sealed class Box { public int Value; }
            class C {
                static void M(Box external) {
    ...
    [Test]
    public void FreshLocalMemberReadDoesNotPublishFreshArgument() {
        var result = Analyze("""
            sealed class Box { }
            sealed class Holder { public Box? Value; }
            class C {
    ...
    [Test]
    public void FreshReceiverDoesNotPublishFreshArgument() {
        var result = Analyze("""
            sealed class Box { }
            sealed class Holder {
