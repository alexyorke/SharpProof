...
""";
        ...
        public async Task EffectSummaryTool_RuntimeArrayConvertAllAndComparerSortSlice_UsesGeneratedImpureEvidence()
        {
            ...
            AssertPurityClassification(summary, "System.Array.ConvertAll(!!0[], System.Converter`2<!!0, !!1>)", "impure", "caller_visible_memory_write");
            AssertEffectVisibilityClassification(summary, "System.Array.ConvertAll(!!0[], System.Converter`2<!!0, !!1>)", "caller_visible");
            AssertPurityClassification(summary, "System.Array.Sort(!!0[], System.Collections.Generic.IComparer`1<!!0>)", "impure", "global_state_read", "impure_callee");
            AssertEffectVisibilityClassification(summary, "System.Array.Sort(!!0[], System.Collections.Generic.IComparer`1<!!0>)", "caller_visible");
            AssertPurityClassification(summary, "System.Array.Sort(!!0[], int, int, System.Collections.Generic.IComparer`1<!!0>)", "impure", "global_state_read", "impure_callee");
            AssertEffectVisibilityClassification(summary, "System.Array.Sort(!!0[], int, int, System.Collections.Generic.IComparer`1<!!0>)", "caller_visible");
            ...
            Assert.That(generatedSymbols, Does.Contain("System.Array.Sort(!!0[], System.Collections.Generic.IComparer`1<!!0>)"));
            Assert.That(generatedSymbols, Does.Contain("System.Array.Sort(!!0[], int, int, System.Collections.Generic.IComparer`1<!!0>)"));
        }
        ...
        public async Task EffectSummaryTool_ArtifactSpec_Resolves_ConfigurationManagerPackageAssembly()
        {
            ...
            var outputPath = Path.Combine(workingDirectory, "ConfigurationManager.AppSettings.SharpProof.EffectSummary.json");
            var artifactSpecPath = Path.Combine(workingDirectory, "artifact-spec.json");
        ...
        public async Task EffectSummaryTool_ArtifactSpec_Resolves_ConfigurationManagerConnectionStringsPackageAssembly()
        {
            ...
            var outputPath = Path.Combine(workingDirectory, "ConfigurationManager.ConnectionStrings.SharpProof.EffectSummary.json");
            var artifactSpecPath = Path.Combine(workingDirectory, "artifact-spec.json");
            ...
            Assert.That(
                methods.Any(method =>
                    string.Equals(method.GetProperty("Symbol").GetString(), "System.Configuration.ConfigurationManager.get_ConnectionStrings()", StringComparison.Ordinal) &&
                    string.Equals(method.GetProperty("PurityClassification").GetProperty("Classification").GetString(), "impure", StringComparison.Ordinal)),
                Is.True);
            Assert.That(
                methods.Any(method =>
...
""";
        ...
        public async Task EffectSummaryTool_ArtifactSpec_SourceSummaryPath_ExcludesReflectionSensitiveReviewedMembers()
        {
            ...
            var environmentSeedOutputPath = Path.Combine(workingDirectory, "environment-seed.SharpProof.EffectSummary.json");
            var environmentOutputPath = Path.Combine(workingDirectory, "environment-regenerated.SharpProof.EffectSummary.json");
            var artifactSpecPath = Path.Combine(workingDirectory, "artifact-spec.json");
        ...
        public async Task EffectSummaryTool_RuntimeAppDomainFriendlyNameSlice_UsesGeneratedImpureEvidence()
        {
            ...
            AssertPurityClassification(summary, "System.AppDomain.get_FriendlyName()", "impure", "global_state_read", "impure_callee");
        ...
        public async Task EffectSummaryTool_RuntimeTimeProviderAndTimeZoneInfoSlice_UsesGeneratedImpureEvidence()
        {
            ...
            AssertPurityClassification(summary, "System.TimeProvider.get_LocalTimeZone()", "impure", "global_state_read", "impure_callee");
        ...
        public async Task EffectSummaryTool_RuntimeHashSetMutatorSlice_UsesGeneratedPurityCatalogEntries()
        {
            ...
            AssertPurityClassification(summary, "System.Collections.Generic.HashSet`1.Clear()", "impure", "object_state_write");
            AssertEffectVisibilityClassification(summary, "System.Collections.Generic.HashSet`1.Clear()", "caller_visible");
            AssertPurityClassification(summary, "System.Collections.Generic.HashSet`1.Remove(!0)", "impure", "caller_visible_memory_write", "object_state_write");
            AssertEffectVisibilityClassification(summary, "System.Collections.Generic.HashSet`1.Remove(!0)", "caller_visible");
            AssertPurityClassification(summary, "System.Collections.Generic.HashSet`1.UnionWith(System.Collections.Generic.IEnumerable`1<!0>)", "impure", "impure_callee");
            AssertEffectVisibilityClassification(summary, "System.Collections.Generic.HashSet`1.UnionWith(System.Collections.Generic.IEnumerable`1<!0>)", "caller_visible");
            ...
            Assert.That(generatedSymbols, Does.Contain("System.Collections.Generic.HashSet`1.UnionWith(System.Collections.Generic.IEnumerable`1<!0>)"));
        }
