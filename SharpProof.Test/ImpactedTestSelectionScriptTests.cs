...
namespace SharpProof.Test
{
    ...
    public sealed class ImpactedTestSelectionScriptTests
    {
        ...
        public async Task ListOnlyJson_SelectsOwningFixtureForChangedTestFile()
        {
            ...
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.Test/SymbolicProgramPointFactTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public async Task ListOnlyJson_SelectsOwningFixtureForChangedToolingTestFile()
        {
            ...
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.ToolingTest/FuzzToolTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public async Task ListOnlyJson_UsesToolingLaneForLinkedEffectSummaryFixture()
        {
            ...
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.Test/EffectSummaryToolTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public async Task ListOnlyJson_UsesToolingLaneForLinkedPackagingFixture()
        {
            ...
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.Test/AnalyzerPackagingTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public async Task ListOnlyJson_SelectsComparerDispatchFixturesForFieldOrPropertyInitializerHelper()
        {
            ...
            Assert.That(evidence.GetProperty("reason").GetString(), Is.EqualTo("Field/property initializer receiver analysis change"));
        }
        ...
        public async Task ListOnlyJson_UsesToolingLaneForLinkedCodeFixFixture()
        {
            ...
            Assert.That(GetStringArray(root, "selectedTestFixtures"), Does.Contain("SharpProofCodeFixTests"));
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.Test/SharpProofCodeFixTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public async Task ListOnlyJson_UsesToolingLaneForLinkedImpactedSelectionFixture()
        {
            ...
            Assert.That(GetStringArray(root, "selectedTestFixtures"), Does.Contain("ImpactedTestSelectionScriptTests"));
            Assert.That(
                GetStringArray(GetEvidenceEntry(root, "SharpProof.Test/ImpactedTestSelectionScriptTests.cs", "changed-test-file"), "selectedTestFixtures"),
        ...
        public void TestImpactInventory_DefinesModulesFixturesAndDependencies()
        {
            ...
            var codeFixDependency = GetInventoryEntry(root, "fixtureDependencies", "SharpProof.CodeFixes/SharpProofCodeFixProvider.cs");
        ...
        public void TestImpactInventory_SourceFilesStayWithinKnownModules()
        {
            ...
            Assert.That(
                GetInventoryEntry(inventory.RootElement, "highFanoutFiles", "SharpProof.Analyzer/Engine/PurityAnalysisEngine.cs")
                    .GetProperty("reason")
                    .GetString(),
