...
public sealed class StringCultureBehaviorTests {
    ...
    public void StartsWith_String_DefaultOverload_MatchesExplicitCurrentCulture() {
        Assert.That(WithCurrentCulture("en-US", ()
            => "encyclop\u00E6dia".StartsWith("encyclopae") == "encyclop\u00E6dia".StartsWith("encyclopae",
            StringComparison.CurrentCulture)), Is.True);
    ...
    public void StartsWith_String_OrdinalOverload_DoesNotChangeWithCurrentCulture() {
        var enUs = WithCurrentCulture("en-US", () => "encyclop\u00E6dia".StartsWith("encyclopae", StringComparison.Ordinal));
        var daDk = WithCurrentCulture("da-DK", () => "encyclop\u00E6dia".StartsWith("encyclopae", StringComparison.Ordinal));
    ...
    public void Contains_String_DefaultOverload_MatchesExplicitOrdinalAcrossCultures() {
        Assert.That(WithCurrentCulture("en-US", ()
            => "encyclop\u00E6dia".Contains("ae") == "encyclop\u00E6dia".Contains("ae", StringComparison.Ordinal)), Is.True);
