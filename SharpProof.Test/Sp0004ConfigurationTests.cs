...
public class TestClass
{
    public int Pure() => 1;
                ...
                treeOptions: ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_scope", "off"));
...
public class TestClass
{
    public int Pure() => 1;
                ...
                ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure", "false"),
                treeOptions: ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure", "true"));
...
public class TestClass
{
    ...
    public int Read() => _value;
            ...
            Assert.That(diagnostics.Select(diagnostic => diagnostic.Id), Has.None.EqualTo(SharpProofDiagnostics.PurityNotVerifiedId));
        }
...
public class TestClass
{
    ...
    public int Read() => _value;
            ...
            Assert.That(diagnostics.Select(diagnostic => diagnostic.Id), Does.Contain(SharpProofDiagnostics.PurityNotVerifiedId));
        }
...
public class TestClass
{
    ...
    public void Write() => Console.WriteLine(""x"");
            ...
            Assert.That(diagnostics.Select(diagnostic => diagnostic.Id), Does.Contain(SharpProofDiagnostics.PurityExplanationId));
        }
...
public class TestClass
{
    ...
    public void Write() => Console.WriteLine(""x"");
            ...
            Assert.That(diagnostics.Select(diagnostic => diagnostic.Id), Has.None.EqualTo(SharpProofDiagnostics.PurityExplanationId));
        }
...
public class GeneratedType
{
    public int Pure() => 1;
                ...
                ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_exclude_generated", "true"),
...
}", ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_namespace_filters", "Allowed"));
...
namespace Other.Feature
{
    public class Calculator
    {
        public int OtherPure() => 2;
                ...
                ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_namespace_filters", "Allowed"),
                treeOptions: ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_namespace_filters", ""));
...
public class TestClass
{
    public int Tiny() => 1;
                ...
                ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_min_complexity", "3"),
                treeOptions: ImmutableDictionary<string, string>.Empty.Add("sharpproof_suggest_missing_enforce_pure_min_complexity", "0"));
...
" + methods + @"
            ...
            {
                var sp0002Count = results[index].Count(diagnostic => diagnostic.Id == SharpProofDiagnostics.PurityNotVerifiedId);
                if (index % 2 == 0)
                {
                    Assert.That(sp0002Count, Is.EqualTo(methodCount), $"Configured compilation {index} should see its impure override.");
                }
                else
                {
                    Assert.That(sp0002Count, Is.Zero, $"Unconfigured compilation {index} should not see another compilation's impure override.");
                }
            }
        }
            ...
            bool concurrentAnalysis = false)
        {
            ...
            var references = GetTrustedPlatformReferences()
                .Add(MetadataReference.CreateFromFile(typeof(SharpProof.Attributes.EnforcePureAttribute).Assembly.Location));
