...
";
        var expectedGetVersion = VerifyCS.Diagnostic("SP0002").WithSpan(13, 19, 13, 26)
            .WithArguments("get_Version");
        var expectedConfigure = VerifyCS.Diagnostic("SP0002").WithSpan(23, 17, 23, 26)
            .WithArguments("Configure");
        var expectedReadVersion = VerifyCS.Diagnostic("SP0002")
            .WithSpan(29, 19, 29, 30).WithArguments("ReadVersion");
        var expectedUseImpureGetter = VerifyCS.Diagnostic("SP0002")
            .WithSpan(41, 19, 41, 34).WithArguments("UseImpureGetter");
        var expectedUseImpureMethodCall = VerifyCS.Diagnostic("SP0002")
