...
public static class InterfaceEnumeratorCatalogSignatureSamples
{
    ...
    public static int Current(IEnumerator<int> enumerator)
    {
        return enumerator.Current;
            ...
            var (enumeratorMatched, enumeratorClassification) = GetGeneratedPurityClassification(getEnumeratorMethod, compilation, additionalFiles);
            ...
            var (currentMatched, currentClassification) = GetGeneratedPurityClassification(currentGetter, compilation, additionalFiles);
...
public static class HashtableCompareInfoAndSortedListCatalogSignatureSamples
{
    ...
    public static object GetKey(SortedList values, int index)
    {
        return values.GetKey(index);
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                (
                    typeof(System.Collections.Hashtable).Assembly.Location,
                ...
                (
                    typeof(System.Globalization.CompareInfo).Assembly.Location,
                    ...
                    "[]"),
                (
                    typeof(System.Collections.SortedList).Assembly.Location,
            ...
            foreach (var trackedMethod in trackedMethods)
            {
                ...
                var (matched, classification) = GetGeneratedPurityClassification(trackedMethod.Symbol, compilation, additionalFiles);
...
public static class ReflectionCtorCatalogSamples
{
    public static object Create()
    {
        ...
        return new DynamicMethod(""SharpProof"", typeof(void), Type.EmptyTypes);
            ...
            AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree, "new AssemblyName(\"SharpProof\")"));
            AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree, "new DynamicMethod(\"SharpProof\", typeof(void), Type.EmptyTypes)"));
        }
