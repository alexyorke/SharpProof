...
public partial class ConstantsTests
{
    ...
    public void GuidCatalog_UsesGeneratedEvidence_NotStaticCatalogs()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Guid.TryParseExact(string?, string?, out System.Guid)"));
    ...
    public void ThreadingSynchronizationMembers_AreSourcedFromSemanticRules_NotStaticCatalogs()
    {
        ...
        foreach (var member in members) AssertNotInManualCatalogs(member);
    }
    ...
    public void GeneratedPathHelpers_AreSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        ...
        foreach (var member in members) Assert.That(Constants.KnownPureBCLMembers, Does.Not.Contain(member));
    }
...
public static class EnvironmentCatalogSignatureSamples
{
    public static string Sample()
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
...
public static class LinkedListMutatorCatalogSignatureSamples
{
    public static void Sample(LinkedList<int> list, LinkedListNode<int> node, int value)
    {
        ...
        AssertNotInManualCatalogs(GetPropertySignature(compilation, syntaxTree, "node.Value", true));
    }
...
public static class DiagnosticsCatalogSignatureSamples
{
    public static MethodBase? Sample(FileVersionInfo fileVersionInfo, StackFrame stackFrame)
    {
        ...
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
...
public static class StaticCustomAttributeCatalogSignatureSamples
{
    public static void Sample(MemberInfo member, Type attributeType)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Attribute.GetCustomAttribute(member, attributeType)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Attribute.GetCustomAttributes(member)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
...
public static class ArrayConvertAllAndComparerSortCatalogSignatureSamples
{
    public static void Sample(int[] values, IComparer<int> comparer)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.ConvertAll(values, static value => value + 1)"));
...
public static class Utf8ParserAndCrc32CatalogSignatureSamples
{
    public static bool Sample(ReadOnlySpan<byte> bytes)
    {
        ...
        var packageAssemblyPath = typeof(Crc32).Assembly.Location;
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Utf8Parser.TryParse(bytes, out int value, out int consumed)"));
...
public static class ArrayPredicateCatalogSignatureSamples
{
    public static int Sample(int[] values)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.Exists(values, static value => value > 0)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.Find(values, static value => value > 0)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.FindIndex(values, static value => value > 0)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.TrueForAll(values, static value => value > 0)"));
    }
...
public static class ArrayGetEnumeratorCatalogSignatureSamples
{
    public static IEnumerator Sample(Array values)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(Array).Assembly.Location,
                "Synthetic.Array.GetEnumerator.SharpProof.EffectSummary.json",
...
public static class LinqDeferredCatalogSignatureSamples
{
    public static IEnumerable<int> Sample(IEnumerable<int> values)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "values.TakeWhile(static value => value > 0)"));
    }
...
public static class LinqDeferredFactoryCatalogSignatureSamples
{
    ...
    public void DeadEnumerablePrefixPlaceholders_AreNotPresentInManualPureCatalogs()
    {
        ...
        foreach (var deadRow in deadRows) Assert.That(Constants.KnownPureBCLMembers, Does.Not.Contain(deadRow));
    }
...
public static class ArrayBinarySearchCatalogSignatureSamples
{
    public static int Sample(Array values, object target, IComparer comparer)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Array.BinarySearch(values, target, comparer)"));
    }
...
public static class SortedSetCatalogSignatureSamples
{
    public static int Sample(SortedSet<int> values, int lower, int upper)
    {
        ...
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "values.GetViewBetween(lower, upper)"));
    }
...
public static class CollectionViewCatalogSignatureSamples
{
    ...
    public static SortedDictionary<int, string>.ValueCollection SortedValues(SortedDictionary<int, string> values) => values.Values;
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(Dictionary<int, string>).Assembly.Location,
                "Synthetic.Dictionary.Keys.SharpProof.EffectSummary.json",
                "System.Collections.Generic.Dictionary`2.get_Keys()",
                "System.Collections.Generic.Dictionary<TKey, TValue>.Keys.get",
                "impure",
                FormatJsonArray("impure_callee", "object_state_write")),
            (
                typeof(Dictionary<int, string>).Assembly.Location,
                "Synthetic.Dictionary.Values.SharpProof.EffectSummary.json",
                "System.Collections.Generic.Dictionary`2.get_Values()",
                "System.Collections.Generic.Dictionary<TKey, TValue>.Values.get",
                "impure",
                FormatJsonArray("impure_callee", "object_state_write")),
            (
                typeof(SortedDictionary<int, string>).Assembly.Location,
                "Synthetic.SortedDictionary.Keys.SharpProof.EffectSummary.json",
                "System.Collections.Generic.SortedDictionary`2.get_Keys()",
                "System.Collections.Generic.SortedDictionary<TKey, TValue>.Keys.get",
                "impure",
                FormatJsonArray("object_state_write")),
            (
                typeof(SortedDictionary<int, string>).Assembly.Location,
                "Synthetic.SortedDictionary.Values.SharpProof.EffectSummary.json",
        ...
        foreach (var trackedMember in trackedMembers)
        {
            ...
            var (matched, classification) = GetGeneratedPurityClassification(getter!, compilation, additionalFiles);
...
public static class InterfaceEnumeratorCatalogSignatureSamples
{
    ...
    public static int Current(IEnumerator<int> enumerator)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(IEnumerable<int>).Assembly.Location,
        ...
        var (enumeratorMatched, enumeratorClassification) =
            GetGeneratedPurityClassification(getEnumeratorMethod, compilation, additionalFiles);
        ...
        var (currentMatched, currentClassification) =
            GetGeneratedPurityClassification(currentGetter, compilation, additionalFiles);
...
public static class HashtableCompareInfoAndSortedListCatalogSignatureSamples
{
    ...
    public static object GetKey(SortedList values, int index)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(Hashtable).Assembly.Location,
                "Synthetic.Hashtable.ContainsKey.SharpProof.EffectSummary.json",
                "System.Collections.Hashtable.ContainsKey(object)",
                "System.Collections.Hashtable.ContainsKey(object)",
                "impure",
                FormatJsonArray("impure_callee")),
            (
                typeof(CompareInfo).Assembly.Location,
                "Synthetic.CompareInfo.Compare.SharpProof.EffectSummary.json",
                "System.Globalization.CompareInfo.Compare(string, string)",
                "System.Globalization.CompareInfo.Compare(string, string)",
                "pure",
                "[]"),
            (
                typeof(SortedList).Assembly.Location,
                "Synthetic.SortedList.GetKey.SharpProof.EffectSummary.json",
        ...
        foreach (var trackedMethod in trackedMethods)
        {
            ...
            var (matched, classification) =
                GetGeneratedPurityClassification(trackedMethod.Symbol, compilation, additionalFiles);
    ...
    public static ImmutableQueue<int> Enqueue(ImmutableQueue<int> queue, int value) => queue.Enqueue(value);
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.ImmutableList.Count.SharpProof.EffectSummary.json",
            ...
            (
                typeof(ImmutableList<int>).Assembly.Location,
                "Synthetic.ImmutableList.Item.SharpProof.EffectSummary.json",
            ...
            (
                ...
                "Synthetic.ImmutableDictionary.CreateRange.SharpProof.EffectSummary.json",
            ...
            (
                ...
                "Synthetic.ImmutableHashSet.CreateRange.SharpProof.EffectSummary.json",
            ...
            (
                ...
                "Synthetic.ImmutableQueue.Enqueue.SharpProof.EffectSummary.json",
        ...
        {
            ("list.Count", "System.Collections.Immutable.ImmutableList<T>.Count.get",
                node => ((IPropertySymbol?)semanticModel.GetSymbolInfo((MemberAccessExpressionSyntax)node).Symbol)
                    ?.GetMethod),
            ("list[0]", "System.Collections.Immutable.ImmutableList<T>.this[int].get",
                node => ((IPropertySymbol?)semanticModel.GetSymbolInfo((ElementAccessExpressionSyntax)node).Symbol)
                    ?.GetMethod),
            ("ImmutableDictionary.CreateRange(items)",
                "System.Collections.Immutable.ImmutableDictionary.CreateRange<TKey, TValue>(System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>>)",
                node => semanticModel.GetSymbolInfo((InvocationExpressionSyntax)node).Symbol as IMethodSymbol),
            ("ImmutableHashSet.CreateRange(values)",
                "System.Collections.Immutable.ImmutableHashSet.CreateRange<T>(System.Collections.Generic.IEnumerable<T>)",
                node => semanticModel.GetSymbolInfo((InvocationExpressionSyntax)node).Symbol as IMethodSymbol),
            ("queue.Enqueue(value)", "System.Collections.Immutable.ImmutableQueue<T>.Enqueue(T)",
                node => semanticModel.GetSymbolInfo((InvocationExpressionSyntax)node).Symbol as IMethodSymbol)
        };
        ...
        foreach (var trackedMember in trackedMembers)
        {
            ...
            var (matched, classification) =
                GetGeneratedPurityClassification(methodSymbol!, compilation, additionalFiles);
...
public static class ImmutableInterfaceCatalogSignatureSamples
{
    ...
    public static IImmutableStack<int> StackSample(IImmutableStack<int> stack)
    {
        ...
        var (queueMatched, _) =
            GetGeneratedPurityClassification(queueMethod, compilation, ImmutableArray<AdditionalText>.Empty);
        ...
        var (stackMatched, _) =
            GetGeneratedPurityClassification(stackMethod, compilation, ImmutableArray<AdditionalText>.Empty);

        Assert.That(queueMatched, Is.False,
            "Interface Dequeue should resolve through dispatch, not direct generated catalog lookup.");
        Assert.That(stackMatched, Is.False,
            "Interface Pop should resolve through dispatch, not direct generated catalog lookup.");
    }
    ...
    public static ValueTask<int> FromResult()
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.ValueTask.ResultCtor.SharpProof.EffectSummary.json",
...
public static class ExceptionAccessorCatalogSignatureSamples
{
    ...
    public void TupleArraySegmentAndReferenceEqualsHelpers_AreSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.ArraySegment<T>.ArraySegment(T[], int, int)"));
    }
    ...
    public void StringNullOrWhiteSpaceSpanOverload_IsNotOnNet80Surface_AndNotStaticCataloged()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("string.IsNullOrWhiteSpace(System.ReadOnlySpan<char>)"));
    }
...
public static class StringJoinCatalogSignatureSamples
{
    ...
    [Test]
    public void
        StringIndexOfCloneCompareToAndToStringHelpers_AreSourcedFromGeneratedPurityEvidence_AndSemanticRules_NotStaticCatalogs()
    {
        var members = new[]
        {
            "string.Clone()",
    ...
    public void StringContainsHelpers_AreSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("string.Contains(string, System.StringComparison)"));
    }
    ...
    [Test]
    public void
        StringBuilderLengthAndHttpResponseSuccessStatusCode_AreSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        var members = new[]
        {
    ...
    public static int Narrow(decimal value)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.Decimal.Compare.SharpProof.EffectSummary.json",
            ...
            (
                typeof(decimal).Assembly.Location,
                "Synthetic.Decimal.ToDouble.SharpProof.EffectSummary.json",
            ...
            (
                typeof(decimal).Assembly.Location,
                "Synthetic.Decimal.ToInt32.SharpProof.EffectSummary.json",
...
public static class KeyValuePairCatalogSignatureSamples<TKey, TValue>
{
    public static TValue Sample(KeyValuePair<TKey, TValue> pair, TKey key, TValue value)
    {
        ...
        var compilation = CSharpCompilation.Create(
            ...
            new CSharpCompilationOptions(OutputKind.DynamicallyLinkedLibrary));
        var ctorSignature =
            GetObjectCreationSignature(compilation, syntaxTree, "new KeyValuePair<TKey, TValue>(key, value)");
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.KeyValuePair.Ctor.SharpProof.EffectSummary.json",
            ...
            (
                typeof(KeyValuePair<int, string>).Assembly.Location,
                "Synthetic.KeyValuePair.Key.SharpProof.EffectSummary.json",
            ...
            (
                typeof(KeyValuePair<int, string>).Assembly.Location,
                "Synthetic.KeyValuePair.Value.SharpProof.EffectSummary.json",
        ...
        {
            var (matched, classification) =
                GetGeneratedPurityClassification(trackedMember.Symbol, compilation, additionalFiles);
            AssertNotInManualCatalogs(trackedMember.Signature);
            Assert.That(matched, Is.True, trackedMember.Signature);
            Assert.That(classification, Is.EqualTo("pure"), trackedMember.Signature);
        }
...
public static class RuntimeVersioningCatalogSignatureSamples
{
    public static FrameworkName Create()
    {
        ...
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new FrameworkName(\".NETCoreApp,Version=v8.0\")"));
    }
...
public static class ReflectionCtorCatalogSamples
{
    public static object Create()
    {
        ...
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new AssemblyName(\"SharpProof\")"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new DynamicMethod(\"SharpProof\", typeof(void), Type.EmptyTypes)"));
    }
    ...
    public static Type? ReflectedType(Type type) => type.ReflectedType;
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.Type.DeclaringMethod.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.DeclaringType.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsAbstract.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsAnsiClass.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsArray.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.Attributes.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsAutoClass.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsAutoLayout.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsByRef.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsClass.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsCOMObject.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsContextful.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsExplicitLayout.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsImport.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsInterface.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsLayoutSequential.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsGenericType.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsGenericTypeDefinition.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsGenericParameter.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsMarshalByRef.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNested.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedAssembly.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedFamANDAssem.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedFamORAssem.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedFamily.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedPrivate.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNestedPublic.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsNotPublic.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsPointer.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsPrimitive.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsPublic.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsSealed.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsSpecialName.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsUnicodeClass.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.IsValueType.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.MemberType.SharpProof.EffectSummary.json",
            ...
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.ReflectedType.SharpProof.EffectSummary.json",
        ...
        foreach (var trackedMember in trackedMembers)
        {
            ...
            var signature = GetPropertySignature(compilation, syntaxTree, trackedMember.Item1);
            var (matched, classification) =
                GetGeneratedPurityClassification(propertySymbol.GetMethod!, compilation, additionalFiles);
    ...
    public static string Sample(CultureInfo culture)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                ...
                "Synthetic.CultureInfo.Name.SharpProof.EffectSummary.json",
                "System.Globalization.CultureInfo.get_Name()",
                "System.Globalization.CultureInfo.Name.get",
                "impure",
                FormatJsonArray("global_state_read", "impure_callee", "object_state_write")));
        var (matched, classification) =
            GetGeneratedPurityClassification(propertySymbol.GetMethod!, compilation, additionalFiles);
...
public static class TypeAssemblyCatalogSignatureSamples
{
    public static Assembly Sample(Type type)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(Type).Assembly.Location,
                "Synthetic.Type.Assembly.SharpProof.EffectSummary.json",
...
public static class IPEndPointCatalogSignatureSamples
{
    ...
    {
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.Regex(string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.IsMatch(string, string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.Match(string, string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.Replace(string, string, string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.IsMatch(string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.Match(string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Text.RegularExpressions.Regex.Replace(string, string)"));
    }
    ...
    {
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.ReadUnaligned(ref byte)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.ReadUnaligned(void*)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.WriteUnaligned(ref byte, !!0)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.WriteUnaligned(void*, !!0)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.As<TFrom, TTo>(ref TFrom)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Runtime.CompilerServices.Unsafe.SizeOf<T>()"));
    }
    ...
    public void BitConverterReadHelpers_AreSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.BitConverter.ToInt32(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers, Does.Not.Contain("System.BitConverter.ToDouble(byte[], int)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.BitConverter.ToDouble(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.BitConverter.ToInt32(byte[], int)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.BitConverter.ToInt32(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.BitConverter.ToDouble(byte[], int)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.BitConverter.ToDouble(System.ReadOnlySpan<byte>)"));
    }
    ...
    public void ConvertCatalog_IsSourcedFromGeneratedPurityEvidence_NotStaticCatalogs()
    {
        ...
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Convert.ToHexString(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers, Does.Not.Contain("System.Convert.FromBase64String(string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Convert.FromBase64CharArray(char[], int, int)"));
        Assert.That(Constants.KnownPureBCLMembers, Does.Not.Contain("System.Convert.FromHexString(string)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain("System.Convert.FromHexString(System.ReadOnlySpan<char>)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.ToBase64String(byte[])"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.ToBase64String(byte[], int, int)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.ToHexString(byte[])"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.ToHexString(byte[], int, int)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.ToHexString(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.FromBase64String(string)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.FromBase64CharArray(char[], int, int)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.FromHexString(string)"));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain("System.Convert.FromHexString(System.ReadOnlySpan<char>)"));
    }
...
public static class CatalogSignatureSamples
{
    public static int Sample()
    {
        ...
        Assert.That(GetInvocationSignature(compilation, syntaxTree, "list.Add(1)"),
            Is.EqualTo("System.Collections.Generic.List<T>.Add(T)"));
        Assert.That(Constants.KnownImpureMethods,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "list.Add(1)")));

        Assert.That(GetPropertySignature(compilation, syntaxTree, "IPAddress.Loopback"),
            Is.EqualTo("System.Net.IPAddress.Loopback.get"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetPropertySignature(compilation, syntaxTree, "IPAddress.Loopback")));

        Assert.That(GetPropertySignature(compilation, syntaxTree, "list.Count"),
            Is.EqualTo("System.Collections.Generic.List<T>.Count.get"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetPropertySignature(compilation, syntaxTree, "list.Count")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "names.Contains(\"alpha\")"),
            Is.EqualTo("System.Collections.ObjectModel.KeyedCollection<TKey, TItem>.Contains(TKey)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "names.Contains(\"alpha\")")));

        Assert.That(GetObjectCreationSignature(compilation, syntaxTree, "new FileNotFoundException(\"missing.txt\")"),
            Is.EqualTo("System.IO.FileNotFoundException.FileNotFoundException(string?)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetObjectCreationSignature(compilation, syntaxTree,
                "new FileNotFoundException(\"missing.txt\")")));

        Assert.That(GetObjectCreationSignature(compilation, syntaxTree, "new string(chars)"),
            Is.EqualTo("string.String(System.ReadOnlySpan<char>)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree, "new string(chars)"));

        Assert.That(
            GetInvocationSignature(compilation, syntaxTree,
                "System.Runtime.InteropServices.Marshal.PtrToStructure<int>(ptr)"),
            Is.EqualTo("System.Runtime.InteropServices.Marshal.PtrToStructure<T>(nint)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "System.Runtime.InteropServices.Marshal.PtrToStructure<int>(ptr)"));
        ...
        Assert.That(
            GetInvocationSignature(compilation, syntaxTree, "CryptographicOperations.FixedTimeEquals(left, right)"),
            Is.EqualTo(
                "System.Security.Cryptography.CryptographicOperations.FixedTimeEquals(System.ReadOnlySpan<byte>, System.ReadOnlySpan<byte>)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "CryptographicOperations.FixedTimeEquals(left, right)"));

        Assert.That(GetObjectCreationSignature(compilation, syntaxTree, "new ArgumentOutOfRangeException(\"value\")"),
            Is.EqualTo("System.ArgumentOutOfRangeException.ArgumentOutOfRangeException(string?)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new ArgumentOutOfRangeException(\"value\")"));

        Assert.That(GetObjectCreationSignature(compilation, syntaxTree, "new BadImageFormatException(\"bad image\")"),
            Is.EqualTo("System.BadImageFormatException.BadImageFormatException(string?)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new BadImageFormatException(\"bad image\")"));

        Assert.That(
            GetObjectCreationSignature(compilation, syntaxTree, "new AttributeUsageAttribute(AttributeTargets.Method)"),
            Is.EqualTo("System.AttributeUsageAttribute.AttributeUsageAttribute(System.AttributeTargets)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new AttributeUsageAttribute(AttributeTargets.Method)"));

        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "object.ReferenceEquals(leftObject, rightObject)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree, "new ArraySegment<int>(values)"));
        AssertNotInManualCatalogs(GetObjectCreationSignature(compilation, syntaxTree,
            "new ArraySegment<int>(values, 0, 1)"));
        ...
        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(bytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA1.HashData(byte[])"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(bytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(bytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(bytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA256.HashData(byte[])"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(bytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(bytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(bytes)"),
            Is.EqualTo("System.Security.Cryptography.MD5.HashData(byte[])"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(bytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(bytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(bytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA384.HashData(byte[])"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(bytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(bytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(bytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA512.HashData(byte[])"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(bytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(bytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(spanBytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA1.HashData(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(spanBytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA1.HashData(spanBytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(spanBytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA256.HashData(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(spanBytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA256.HashData(spanBytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(spanBytes)"),
            Is.EqualTo("System.Security.Cryptography.MD5.HashData(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(spanBytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "MD5.HashData(spanBytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(spanBytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA384.HashData(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(spanBytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA384.HashData(spanBytes)")));

        Assert.That(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(spanBytes)"),
            Is.EqualTo("System.Security.Cryptography.SHA512.HashData(System.ReadOnlySpan<byte>)"));
        Assert.That(Constants.KnownPureBCLMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(spanBytes)")));
        Assert.That(Constants.KnownFreshOwnedArrayReturningMembers,
            Does.Not.Contain(GetInvocationSignature(compilation, syntaxTree, "SHA512.HashData(spanBytes)")));
    }
...
public static class CatalogConflictSamples
{
    public static void Sample()
    {
        ...
        AssertCatalogMembership(GetInvocationSignature(compilation, syntaxTree, "list.Add(1)"), false, false);
        AssertCatalogMembership(GetPropertySignature(compilation, syntaxTree, "IPAddress.Loopback"), false, false);
        AssertCatalogMembership(GetPropertySignature(compilation, syntaxTree, "list.Count"), false, false);
    }
...
public static class RecentCatalogSignatureSamples
{
    public static long Sample(Guid guid, string text, DateTimeOffset value)
    {
        ...
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "Guid.TryParse(text, out var parsed)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "Guid.TryParseExact(text, \"D\", out parsed)"));
        ...
        AssertCatalogMembership(GetObjectCreationSignature(compilation, syntaxTree, "new string(charSpan)"), false,
            false);
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.LeadingZeroCount(1u)"));
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "BitOperations.LeadingZeroCount(1ul)"));
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.RotateLeft((nuint)1, 1)"));
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.RotateRight((nuint)1, 1)"));
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "BitOperations.RoundUpToPowerOf2(1u)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.RoundUpToPowerOf2(1ul)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.TrailingZeroCount(1)"));
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "BitOperations.TrailingZeroCount(1u)"));
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "BitOperations.TrailingZeroCount(1L)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "BitOperations.TrailingZeroCount(1ul)"));
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "DateTimeOffset.Compare(value, added)"));
        ...
        AssertNotInManualCatalogs(
            GetInvocationSignature(compilation, syntaxTree, "DateTimeOffset.Equals(value, added)"));
...
public static class DateTimeCatalogSignatureSamples
{
    public static DateTime Sample(DateTime value, TimeSpan offset)
    {
        ...
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree, "value.AddYears(8)"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "DateTime.FromBinary(value.ToBinary())"));
        AssertNotInManualCatalogs(GetInvocationSignature(compilation, syntaxTree,
            "DateTime.FromOADate(value.ToOADate())"));
...
public static class ReviewedRuntimeHelperCatalogSignatureSamples
{
    public static int Sample(ReadOnlySpan<int> values, Delegate left, Delegate right)
    {
        ...
        var pipelinesAssemblyPath = Directory
            .GetFiles(sharedDirectory, "System.IO.Pipelines.dll", SearchOption.AllDirectories)
...
public static class ConfigurationManagerConnectionStringsCatalogSignatureSamples
{
    public static ConnectionStringSettingsCollection Sample()
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            (
                typeof(ConfigurationManager).Assembly.Location,
                "Synthetic.ConfigurationManager.ConnectionStrings.SharpProof.EffectSummary.json",
...
public static class CancelEventArgsCatalogSignatureSamples
{
    public static void Write(CancelEventArgs writeArgs)
    {
        ...
        AssertNotInManualCatalogs(GetPropertySignature(compilation, syntaxTree, "writeArgs.Cancel", true));
    }
