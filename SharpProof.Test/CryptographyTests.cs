...
{
    [EnforcePure]
    public byte[] {|SP0002:TestMethod|}(string data)
    {
...
{
    [EnforcePure]
    public int {|SP0002:TestMethod|}(int maxExclusive)
    {
...
{
    [EnforcePure]
    public void {|SP0002:TestMethod|}(SignedCms cms, byte[] data)
    {
        cms.Decode(data);
    }
}";
