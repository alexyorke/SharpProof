...
public sealed class SmtFormulaVersionRewriterTests {
    ...
    public void RewriteSymbolVersions_DoesNotRewritePrefixSiblingVariableName() {
        ...
        var rewritten = SymbolicIrSubstitution.ReplaceTerm(sibling, source, new SymbolicVariableTerm("myField@v1", SmtValueKind.Int));
    ...
    public void RewriteSymbolVersions_RewritesElementAccessForTargetVariable() {
        ...
        var element = new SymbolicElementTerm(source, new SymbolicIntegerConstantTerm(0), SmtValueKind.Int);
