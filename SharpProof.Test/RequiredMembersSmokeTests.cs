...
public class Person
{
    public required string {|SP0004:FirstName|} { get; init; }
    public required string {|SP0004:LastName|} { get; init; }
...
{
    public required int {|SP0004:Count|} { get; set; }

    [EnforcePure]
    public void {|SP0002:Increment|}()
    {
        Count++;
    }
}
...
{
    public required string {|SP0004:Name|} { get; init; } = name;
    public required decimal {|SP0004:Price|} { get; init; } = price;
...
public record User
{
    public required string {|SP0004:Name|} { get; init; }
    public required string {|SP0004:Email|} { get; init; }
...
{
    public required string {|SP0004:Title|} { get; init; }
    public string? {|SP0004:Description|} { get; init; }
...
{
    public required string {|SP0004:Username|} { get; init; }
    public int {|SP0004:Age|} { get; set; }
    ...
    [EnforcePure]
    public void {|SP0002:UpdateAge|}(int newAge)
    {
        Age = newAge;
    }
...
public class UserProfile
{
    ...
    [EnforcePure]
    public int {|SP0002:GenerateUniqueId|}()
    {
        return Guid.NewGuid().GetHashCode();
    }

    [EnforcePure]
    public void {|SP0002:SaveProfile|}()
    {
        _lastId++;
...
{
    public required int {|SP0004:TimeoutMs|} { get; init; }
}

public struct Coordinates
{
    public required double {|SP0004:Latitude|} { get; init; }
    public required double {|SP0004:Longitude|} { get; init; }
}

public class AppConfiguration
{
    public required Settings {|SP0004:AppSettings|} { get; init; }
    public required Coordinates {|SP0004:DefaultLocation|} { get; init; }
...
{
    public required int {|SP0004:Id|} { get; init; }
    public required string {|SP0004:Name|} { get; init; }
    public required decimal {|SP0004:Price|} { get; init; }
    ...
    [EnforcePure]
    public string {|SP0002:GetProductSummary|}()
    {
...
{
    [EnforcePure]
    public void {|SP0002:UpdateProductName|}(Product product, string newName)
    {
...
public struct Point
{
    public required double {|SP0004:X|} { get; init; }
    public required double {|SP0004:Y|} { get; init; }
