...
{
    [EnforcePure]
    internal int {|SP0002:ComputeWithUnknownImplementation|}(IWorker worker, int value)
    {
...
{
    [EnforcePure]
    public int {|SP0002:ComputeWithUnknownPublicImplementation|}(IPublicWorker worker, int value)
    {
        return worker.Compute(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:Process|}(IPublicCounter counter, int value)
    {
        return counter.Increment(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:Process|}(PureCounter counter, int value)
    {
...
{
    [EnforcePure]
    public int {|SP0002:ProcessGeneric|}<T>(T counter, int value) where T : IMixedCounter
    {
        return counter.Increment(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:Run|}<T>(T worker, int value) where T : IPublicWorker
    {
        return worker.Compute(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:ProcessMixedDispatch|}(IMixedCounter counter, int value)
    {
        return counter.Increment(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:ComputeWithVirtualDispatch|}(BaseWorker worker, int value)
    {
        return worker.Compute(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:ComputeWithProtectedOrInternalVirtual|}(BaseWorker worker, int value)
    {
        return worker.Compute(value);
    }
}
...
{
    [EnforcePure]
    public int {|SP0002:Process|}(IReassignedCounter unknown, int value)
    {
