...
";
    ...
    public void SymbolicCli_ShouldExposeBoundedExplainReportFormats()
    {
        AssertSymbolicCliSourceContains(
            ...
            ("SymbolicCliExplainReport.cs", "public int SchemaVersion => 2"),
            ("SymbolicCliExplainReport.cs", "public SymbolicQueryResult Invariant"),
            ("SymbolicCliExplainReport.cs", "public IReadOnlyList<SymbolicRuntimeHazard> RuntimeHazards"),
