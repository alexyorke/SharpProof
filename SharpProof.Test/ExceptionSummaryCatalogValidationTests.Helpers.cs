...
""";
            ...
            string diagnosticId)
        {
            ...
            Assert.That(actual.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo(expected.Properties[SharpProofDiagnostics.ExceptionTypesProperty]));
            Assert.That(actual.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo(expected.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty]));
            Assert.That(actual.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo(expected.Properties[SharpProofDiagnostics.ExceptionSourcesProperty]));

            var expectedHasSymbol = expected.Properties.TryGetValue(SharpProofDiagnostics.ExceptionSymbolProperty, out var expectedSymbol);
            var actualHasSymbol = actual.Properties.TryGetValue(SharpProofDiagnostics.ExceptionSymbolProperty, out var actualSymbol);
            ...
            var expectedHasEdges = expected.Properties.TryGetValue(SharpProofDiagnostics.ExceptionEdgesProperty, out var expectedEdges);
            var actualHasEdges = actual.Properties.TryGetValue(SharpProofDiagnostics.ExceptionEdgesProperty, out var actualEdges);
