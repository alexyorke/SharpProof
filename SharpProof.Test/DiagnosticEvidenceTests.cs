...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ConsoleWriteLine_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ConsoleClear_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_TypeDescriptorGetConverter_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    public TypeConverter TestMethod(Type type)
    {
        ...
        [Test]
        public async Task Sp0002_TypeDescriptorGetProperties_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.ComponentModel;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public PropertyDescriptorCollection TestMethod(object value)
    {
        ...
        [Test]
        public async Task Sp0002_ActivatorCreateInstanceOfT_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ActivatorCreateInstanceType_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public object TestMethod(Type type)
    {
        ...
        [Test]
        public async Task Sp0002_ActivatorCreateInstanceFrom_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    public ObjectHandle TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_GCCollect_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_GCGetTotalMemory_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public long TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_GCGetGeneration_UsesGeneratedPuritySummarySource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(object value)
    {
        ...
        [Test]
        public async Task Sp0002_RandomConstructor_UsesRandomSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public Random TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_RandomNext_UsesRandomSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(Random random)
    {
        ...
        [Test]
        public async Task Sp0002_StringBuilderAppend_UsesStringBuilderSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Text;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(StringBuilder sb)
    {
        ...
        [Test]
        public async Task Sp0002_ArrayReverse_UsesArrayMutationSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] values)
    {
        ...
        [Test]
        public async Task Sp0002_ArraySortWithComparison_UsesArrayMutationSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] values, Comparison<int> comparison)
    {
        ...
        [Test]
        public async Task Sp0002_DoubleDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_UseAfterDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_AliasUseAfterDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ReturnUseAfterDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_UseAfterUsingStatement_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_MissingDispose_UsesSymbolicResourceLifetimeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_XDocumentParse_UsesXmlLinqSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
...
public class TestClass
{
    ...
    public XDocument TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_XElementValue_UsesXmlLinqSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Xml.Linq;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(XElement element)
    {
        ...
        [Test]
        public async Task Sp0002_XNodeRemove_UsesXmlLinqSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Xml.Linq;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Counter<int> counter)
    {
        ...
        [Test]
        public async Task Sp0002_MemoryStreamConstructor_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public MemoryStream TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_StringReaderConstructor_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public StringReader TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_StringReaderReadToEnd_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(StringReader reader)
    {
        ...
        [Test]
        public async Task Sp0002_StreamReaderConstructor_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public StreamReader TestMethod(Stream stream)
    {
        ...
        [Test]
        public async Task Sp0002_StreamWriterWriteLine_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(StreamWriter writer)
    {
        ...
        [Test]
        public async Task Sp0002_StringWriterWrite_UsesIoStreamTextSemanticRuleSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    private int CustomApi()
    {
        return 42;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("global_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("config_known_impure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.CustomApi"));
        }

        [Test]
        public async Task Sp0002_ConfiguredKnownImpureTargetMethod_IncludesConfigCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return 42;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("config_known_impure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.TestMethod"));
        }

        [Test]
        public async Task Sp0002_ConfiguredKnownImpureTypeProperty_IncludesNamespaceOrTypeCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(Boundary boundary)
    {
        return boundary.Value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("Boundary.Value"));
        }

        [Test]
        public async Task Sp0002_ConfiguredKnownImpureTypeOverridesKnownPureBclHeuristic()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(int value)
    {
        return Math.Abs(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Math.Abs"));
        }

        [Test]
        public async Task Sp0002_ConfiguredKnownPureMethodOverridesConfiguredImpureType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(int value)
    {
        ...
        [Test]
        public async Task Sp0002_ConfiguredKnownPurePropertyOverridesConfiguredImpureNamespace()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Net;
using SharpProof.Attributes;
    ...
    public string TestMethod(Uri value)
    {
        return value.ToString();
            ...
            var compilation = CSharpCompilation.Create(
                ...
                new[] { syntaxTree },
                GetTrustedPlatformReferences().Add(MetadataReference.CreateFromFile(typeof(SharpProof.Attributes.EnforcePureAttribute).Assembly.Location)),
            ...
            var methodSymbol = (IMethodSymbol)compilation.GetSemanticModel(syntaxTree).GetSymbolInfo(invocation).Symbol!;
            var catalogType = typeof(SharpProofAnalyzer).Assembly.GetType("SharpProof.Analyzer.GeneratedPurityCatalog", throwOnError: true)!;
...
public class TestClass
{
    ...
    public string TestMethod(Uri value)
    {
        return $""{value}"";
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("InterpolatedStringPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
...
public class TestClass
{
    ...
    public bool TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_AppContextTargetFrameworkName_UsesGeneratedPurityCatalogSource()
        {
            const string source = @"
#nullable enable
using System;
...
public class TestClass
{
    ...
    public string? TestMethod()
    {
        return AppContext.TargetFrameworkName;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.AppContext.TargetFrameworkName"));
        }
...
public class TestClass
{
    ...
    public bool TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_TaskDelay_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading.Tasks;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public async Task TestMethod()
    {
        await Task.Delay(100);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Tasks.Task.Delay"));
        }

        [Test]
        public async Task Sp0002_TaskRun_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading.Tasks;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public async Task TestMethod()
    {
        await Task.Run(static () => { });
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("caller_visible_memory_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Tasks.Task.Run"));
        }

        [Test]
        public async Task Sp0002_CancellationTokenIsCancellationRequested_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(CancellationToken token)
    {
        return token.IsCancellationRequested;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("global_state_read"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.CancellationToken.IsCancellationRequested.get"));
        }

        [Test]
        public async Task Sp0002_TaskIsCompleted_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading.Tasks;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Task task)
    {
        return task.IsCompleted;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("global_state_read"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Tasks.Task.IsCompleted.get"));
        }
    ...
    public FrameworkName TestMethod()
    {
        return new FrameworkName("".NETCoreApp,Version=v8.0"");
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    "Synthetic.FrameworkName.Constructor.SharpProof.EffectSummary.json",
...
public class TestClass
{
    ...
    public AggregateException Flatten(AggregateException value)
    {
        return value.Flatten();
            ...
            Assert.That(
                diagnostics.Where(candidate => candidate.Id == SharpProofDiagnostics.PurityNotVerifiedId).Select(candidate => candidate.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty]).Distinct().ToArray(),
...
public class TestClass
{
    ...
    public string TestMethod()
    {
        return Directory.GetCurrentDirectory();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Directory.GetCurrentDirectory"));
...
public class TestClass
{
    ...
    public void TestMethod(string path)
    {
        Environment.CurrentDirectory = path;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("global_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.CurrentDirectory.set"));
...
public class TestClass
{
    ...
    public void TestMethod(string path)
    {
        Directory.SetCurrentDirectory(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("global_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Directory.SetCurrentDirectory"));
...
public class TestClass
{
    ...
    public bool TestMethod(string path)
    {
        return Directory.Exists(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Directory.Exists"));
...
public class TestClass
{
    ...
    public bool TestMethod(string path)
    {
        return File.Exists(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.File.Exists"));
...
public class TestClass
{
    ...
    public DirectoryInfo TestMethod(string path)
    {
        return Directory.CreateDirectory(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Directory.CreateDirectory"));
...
public class TestClass
{
    ...
    public DirectoryInfo TestMethod()
    {
        return Directory.CreateTempSubdirectory(""sharpproof-test-"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Directory.CreateTempSubdirectory"));
...
public class TestClass
{
    ...
    public object CurrentRegion()
    {
        return RegionInfo.CurrentRegion;
            ...
            Assert.That(
                purityDiagnostics.Select(diagnostic => diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty]).Distinct().ToArray(),
                Is.EqualTo(new[] { "generated_purity_summary" }));
...
public class TestClass
{
    ...
    public CultureInfo TestMethod()
    {
        return CultureInfo.GetCultureInfo(""en-US"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Globalization.CultureInfo.GetCultureInfo(string)"));
...
public class TestClass
{
    ...
    public object TestMethod(object value)
    {
        return Convert.ChangeType(value, typeof(int));
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Convert.ChangeType"));
...
public class TestClass
{
    ...
    public int TestMethod(IntPtr ptr)
    {
        return Marshal.PtrToStructure<int>(ptr);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Runtime.InteropServices.Marshal.PtrToStructure"));
...
public class TestClass
{
    ...
    public bool TestMethod(ClaimsPrincipal principal)
    {
        return principal.IsInRole(""admin"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Security.Claims.ClaimsPrincipal.IsInRole"));
...
public class TestClass
{
    ...
    public Process TestMethod()
    {
        return Process.GetCurrentProcess();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.Process.GetCurrentProcess"));
        }
...
public class TestClass
{
    ...
    public bool TestMethod()
    {
        ...
        return left.CompareTo(right) == 0 &&
            ...
            var diagnostics = await GetAnalyzerDiagnosticsAsync(source);
            var probe = CreateGeneratedPurityProbeContext(source);
            var matched = ResolveGeneratedPurityByExpressionTexts(
                    probe,
                    null,
                    "new Version(1, 2, 3, 4)",
                    ...
                    "left.Equals(right)",
                    "left.Major")
                .Select(static resolution => resolution.Matched)
                .ToArray();
...
public class TestClass
{
    ...
    public int TestMethod(Type left, Type right, object boxed)
    {
        ...
        return sameType == sameObject ? left.GetHashCode() : right.GetHashCode();
            ...
            var diagnostics = await GetAnalyzerDiagnosticsAsync(source);
            var probe = CreateGeneratedPurityProbeContext(source);
            var classifications = ResolveGeneratedPurityByExpressionTexts(
                    probe,
                    null,
                    "left.Equals(right)",
                    "left.Equals(boxed)",
                    "left.GetHashCode()",
                    "right.GetHashCode()")
                .Select((resolution, index) => (Expression: new[]
                {
                    "left.Equals(right)",
                    "left.Equals(boxed)",
                    "left.GetHashCode()",
...
public class TestClass
{
    ...
    public int TestMethod(bool left, bool right, char value, char other)
    {
        ...
        return compare;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("char.ConvertToUtf32(char, char)"));
...
public class TestClass
{
    ...
    public string TestMethod(int codePoint)
    {
        return char.ConvertFromUtf32(codePoint);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("char.ConvertFromUtf32(int)"));
    ...
    public int TestMethod(ReadOnlySpan<int> readOnly, Span<int> writable)
    {
        ...
        return readOnly.Length + writable.Length + head.Length + readOnlyBytes.Length + writableBytes.Length + (readOnly.IsEmpty ? 0 : 1) + (writable.IsEmpty ? 0 : 1);
            ...
            var matched = ResolveGeneratedPurityByExpressionTexts(
                    ...
                    null,
                    "readOnly.Slice(0, 0)",
                    "MemoryMarshal.AsBytes(readOnly)",
                    "MemoryMarshal.AsBytes(writable)",
                    "readOnly.Length",
                    "writable.Length",
                    "readOnly.IsEmpty",
                    "writable.IsEmpty")
    ...
    public List<int> EnumerableMethod(IEnumerable<int> values)
    {
        return new List<int>(values);
            ...
            Assert.That(
                ...
                Is.EqualTo(new[] { "generated_purity_summary" }));
            Assert.That(
                purityDiagnostics.Select(diagnostic => diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty]).Distinct().ToArray(),
...
public class TestClass
{
    ...
    public Span<int> ViewItems(List<int> values)
    {
        return CollectionsMarshal.AsSpan(values);
            ...
            var diagnostics = await GetAnalyzerDiagnosticsAsync(source);
            var purityDiagnostics = diagnostics.Where(diagnostic => diagnostic.Id == SharpProofDiagnostics.PurityNotVerifiedId).ToArray();
            var syntaxTree = CSharpSyntaxTree.ParseText(source, new CSharpParseOptions(LanguageVersion.Preview));
            var compilation = CSharpCompilation.Create(
                "GeneratedPurityProbe",
                new[] { syntaxTree },
...
public class TestClass
{
    ...
    public bool BagTryTakeMethod(ConcurrentBag<int> bag)
    {
        ...
        [Test]
        public async Task Sp0002_DiagnosticListenerConstructor_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public DiagnosticListener TestMethod()
    {
        return new DiagnosticListener(""test"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ObjectCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.DiagnosticListener.DiagnosticListener(string)"));
        }
    ...
    public bool ImpureHelper(MemberInfo member, Type attributeType)
    {
        return Attribute.IsDefined(member, attributeType);
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    "Synthetic.StaticCustomAttribute.GetCustomAttribute.SharpProof.EffectSummary.json",
                    "System.Attribute.GetCustomAttribute(System.Reflection.MemberInfo, System.Type)",
                    "System.Attribute.GetCustomAttribute(System.Reflection.MemberInfo, System.Type)",
                    "pure",
                    FormatJsonArray()),
                (
                    "Synthetic.StaticCustomAttribute.GetCustomAttributes.SharpProof.EffectSummary.json",
                    "System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo)",
                    "System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo)",
                    "conservative_unknown",
                    FormatJsonArray("unknown_callee")),
                (
                    "Synthetic.StaticCustomAttribute.IsDefined.SharpProof.EffectSummary.json",
                    "System.Attribute.IsDefined(System.Reflection.MemberInfo, System.Type)",
                    "System.Attribute.IsDefined(System.Reflection.MemberInfo, System.Type)",
                    "impure",
                    FormatJsonArray("impure_callee")),
                (
                    "Synthetic.StaticCustomAttribute.CustomAttributeData.GetCustomAttributes.SharpProof.EffectSummary.json",
            ...
            Assert.That(purityDiagnostics, Has.Length.EqualTo(2));
            Assert.That(
                purityDiagnostics.Select(diagnostic => diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty]).OrderBy(symbol => symbol, StringComparer.Ordinal).ToArray(),
                Is.EqualTo(new[]
                {
    ...
    public int TestMethod()
    {
        ...
        return (browsable is null ? 0 : 1) + (description is null ? 0 : 1) + (conditional is null ? 0 : 1);
            ...
            var matched = ResolveGeneratedPurityByExpressionTexts(
                    ...
                    "new DescriptionAttribute(\"sample\")",
                    "new ConditionalAttribute(\"DEBUG\")")
                .Select(static resolution => resolution.Matched)
                .ToArray();
...
public class TestClass
{
    ...
    public RegularExpressionAttribute TestMethod()
    {
        return new RegularExpressionAttribute(""^[a-z]+$"");
            ...
            Assert.That(resolution.Matched, Is.True, "Generated purity catalog should resolve RegularExpressionAttribute..ctor(string).");
            Assert.That(resolution.Classification, Is.EqualTo("impure"),
    ...
    public bool TestMethod(ICollection<int> collection, IList<int> list, int value)
    {
        return collection.Contains(value) && list.IndexOf(value) >= 0 && collection.Count >= 0;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    "Synthetic.InterfaceCollectionLookup.Contains.SharpProof.EffectSummary.json",
                ...
                (
                    "Synthetic.InterfaceCollectionLookup.IndexOf.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.IList`1.IndexOf(!0)",
                    "System.Collections.Generic.IList<T>.IndexOf(T)",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceCollectionLookup.Count.SharpProof.EffectSummary.json",
    ...
    public void TestMethod(ICollection<int> collection, IList<int> list, int value)
    {
        ...
        list.RemoveAt(0);
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                typeof(ICollection<>).Assembly.Location,
                (
                    "Synthetic.InterfaceCollectionMutators.Add.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.ICollection`1.Add(!0)",
                    "System.Collections.Generic.ICollection<T>.Add(T)",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceCollectionMutators.Remove.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.ICollection`1.Remove(!0)",
                    "System.Collections.Generic.ICollection<T>.Remove(T)",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceCollectionMutators.Clear.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.ICollection`1.Clear()",
                    "System.Collections.Generic.ICollection<T>.Clear()",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceCollectionMutators.Insert.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.IList`1.Insert(int, !0)",
                    "System.Collections.Generic.IList<T>.Insert(int, T)",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceCollectionMutators.RemoveAt.SharpProof.EffectSummary.json",
    ...
    public int TestMethod(IEnumerable<int> values, IEnumerator<int> enumerator)
    {
        ...
        return enumerator.Current;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    "Synthetic.InterfaceEnumeratorContracts.GetEnumerator.SharpProof.EffectSummary.json",
                    "System.Collections.Generic.IEnumerable`1.GetEnumerator()",
                    "System.Collections.Generic.IEnumerable<T>.GetEnumerator()",
                    "conservative_unknown",
                    FormatJsonArray("abstract", "metadata_only_or_external", "no_il_body")),
                (
                    "Synthetic.InterfaceEnumeratorContracts.Current.SharpProof.EffectSummary.json",
...
public class TestClass
{
    ...
    public object GetKey(SortedList values, int index)
    {
        return values.GetKey(index);
            ...
            Assert.That(purityDiagnostics, Has.Length.EqualTo(2));
            Assert.That(
                purityDiagnostics.Select(diagnostic => diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty]).Distinct().ToArray(),
            ...
            Assert.That(
                purityDiagnostics.All(diagnostic => !diagnostic.Properties.ContainsKey(SharpProofDiagnostics.ImpurityCatalogSourceProperty)),
                Is.True,
...
public class TestClass
{
    ...
    public int TestMethod(SortedDictionary<int, string> values)
    {
        ...
        [Test]
        public async Task Sp0002_ConservativeUnknownGeneratedPurity_SuppressesKnownPureConstructorFallback()
        {
            const string source = @"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod()
    {
            ...
            var diagnostics = await GetAnalyzerDiagnosticsAsync(
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.StringConstructor.SharpProof.EffectSummary.json",
        ...
        [Test]
        public async Task Sp0002_AppContextSetSwitch_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        AppContext.SetSwitch(""System.Runtime.Serialization.EnableUnsafeBinaryFormatterSerialization"", true);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.AppContext.SetSwitch"));
        }

        [Test]
        public async Task Sp0002_ListFindLast_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(List<int> values)
    {
        return values.FindLast(static value => value > 0);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.List<T>.FindLast(System.Predicate<T>)"));
        }

        [Test]
        public async Task Sp0002_QueueTryPeek_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Queue<int> values)
    {
        return values.TryPeek(out var value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.Queue<T>.TryPeek(out T)"));
        }

        public async Task Sp0002_DictionaryClear_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Dictionary<int, int> values)
    {
        values.Clear();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.Dictionary<TKey, TValue>.Clear()"));
        }

        [Test]
        public async Task Sp0002_DictionaryAdd_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Dictionary<int, int> values)
    {
        values.Add(1, 2);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.Dictionary<TKey, TValue>.Add(TKey, TValue)"));
        }

        [Test]
        public async Task Sp0002_DictionaryRemove_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Dictionary<int, int> values, int key)
    {
        return values.Remove(key);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.Dictionary<TKey, TValue>.Remove(TKey)"));
        }

        [Test]
        public async Task Sp0002_DictionaryTryAdd_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Dictionary<int, int> values)
    {
        return values.TryAdd(1, 2);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.Dictionary<TKey, TValue>.TryAdd(TKey, TValue)"));
        }

        [Test]
        public async Task Sp0002_ArrayFind_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(int[] values)
    {
        return Array.Find(values, static value => value > 0);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Find"));
        }

        [Test]
        public async Task Sp0002_ArrayBinarySearch_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using System.Collections;
...
public class TestClass
{
    ...
    public int TestMethod(Array values, object target, IComparer comparer)
    {
        return Array.BinarySearch(values, target, comparer);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.BinarySearch"));
        }

        [Test]
        public async Task Sp0002_ArrayCopyRange_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] source, int[] destination)
    {
        Array.Copy(source, 0, destination, 0, source.Length);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Copy(System.Array, int, System.Array, int, int)"));
        }

        [Test]
        public async Task Sp0002_ArrayCopyTo_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] source, int[] destination)
    {
        source.CopyTo(destination, 0);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.CopyTo(System.Array, int)"));
        }

        [Test]
        public async Task Sp0002_ArrayCopyLengthOverload_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Array source, Array destination, int length)
    {
        Array.Copy(source, destination, length);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Copy(System.Array, System.Array, int)"));
        }

        [Test]
        public async Task Sp0002_ArrayConstrainedCopy_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Array source, Array destination, int length)
    {
        Array.ConstrainedCopy(source, 0, destination, 0, length);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.ConstrainedCopy(System.Array, int, System.Array, int, int)"));
        }

        [Test]
        public async Task Sp0002_ArrayClearFullArray_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] values)
    {
        Array.Clear(values);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Clear(System.Array)"));
        }

        [Test]
        public async Task Sp0002_ArrayClearRange_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] values)
    {
        Array.Clear(values, 0, values.Length);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Clear(System.Array, int, int)"));
        }

        [Test]
        public async Task Sp0002_ArrayFill_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] values)
    {
        Array.Fill(values, 42);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Fill"));
        }

        [Test]
        public async Task Sp0002_ArrayResize_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        Array.Resize(ref values, values.Length + 1);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("caller_visible_memory_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Array.Resize"));
        }

        [Test]
        public async Task Sp0002_BufferBlockCopy_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(int[] source, int[] destination)
    {
        Buffer.BlockCopy(source, 0, destination, 0, source.Length * sizeof(int));
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Buffer.BlockCopy(System.Array, int, System.Array, int, int)"));
        }

        [Test]
        public async Task Sp0002_SortedSetGetViewBetween_NoLongerUsesManualPureFallback()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(SortedSet<int> values, int lower, int upper)
    {
        ...
        return 0;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.SortedSet<int>.GetViewBetween"));
        }

        [Test]
        public async Task Sp0002_AppDomainCurrentDomain_IsNowPureInGeneratedPurityCatalog()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public AppDomain TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_AppDomainBaseDirectoryOnParameter_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(AppDomain domain)
    {
        return domain.BaseDirectory;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.AppDomain.BaseDirectory.get"));
        }

        [Test]
        public async Task Sp0002_AppDomainFriendlyNameOnParameter_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(AppDomain domain)
    {
        return domain.FriendlyName;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.AppDomain.FriendlyName.get"));
        }

        [Test]
        public async Task Sp0002_StopwatchGetTimestamp_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public long TestMethod()
    {
        return Stopwatch.GetTimestamp();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.Stopwatch.GetTimestamp"));
        }

        [Test]
        public async Task Sp0002_FrameworkNameConstructor_UsesGeneratedPurityCatalogSource()
        {
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                typeof(System.Runtime.Versioning.FrameworkName).Assembly.Location,
                (
...
public class TestClass
{
    ...
    public FrameworkName TestMethod()
    {
        return new FrameworkName("".NETCoreApp,Version=v8.0"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("object_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ObjectCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Runtime.Versioning.FrameworkName"));
        }
...
public class TestClass
{
    ...
    public Stopwatch TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_StopwatchElapsedTicksOnParameter_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public long TestMethod(Stopwatch stopwatch)
    {
        return stopwatch.ElapsedTicks;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.Stopwatch.ElapsedTicks.get"));
        }

        [Test]
        public async Task Sp0002_StopwatchStartOnParameter_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Stopwatch stopwatch)
    {
        stopwatch.Start();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.Stopwatch.Start"));
        }
...
public class TestClass
{
    ...
    public long TestMethod()
    {
        return Stopwatch.Frequency;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("FieldReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
        ...
        [Test]
        public async Task Sp0002_StopwatchFrequency_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public long TestMethod()
    {
        return Stopwatch.Frequency;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("FieldReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Diagnostics.Stopwatch"));
        }

        [Test]
        public async Task Sp0002_StopwatchIsHighResolution_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Diagnostics;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_TimeProviderSystem_IsNowPureInGeneratedPurityCatalog()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public TimeProvider TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_TimeProviderLocalTimeZoneOnParameter_UsesDynamicDispatchEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public TimeZoneInfo TestMethod(TimeProvider provider)
    {
        return provider.LocalTimeZone;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("dynamic_dispatch"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties.ContainsKey(SharpProofDiagnostics.ImpurityCatalogSourceProperty), Is.False);
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.TimeProvider.LocalTimeZone.get"));
        }

        [Test]
        public async Task Sp0002_TimeZoneInfoFindSystemTimeZoneById_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public TimeZoneInfo TestMethod()
    {
        return TimeZoneInfo.FindSystemTimeZoneById(""UTC"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.TimeZoneInfo.FindSystemTimeZoneById"));
        }

        [Test]
        public async Task Sp0002_TimeZoneInfoConvertTimeDateTimeOffset_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public DateTimeOffset TestMethod(DateTimeOffset value, TimeZoneInfo timeZone)
    {
        return TimeZoneInfo.ConvertTime(value, timeZone);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.TimeZoneInfo.ConvertTime(System.DateTimeOffset, System.TimeZoneInfo)"));
        }

        [Test]
        public async Task Sp0002_GuidNewGuid_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public Guid TestMethod()
    {
        return Guid.NewGuid();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Guid.NewGuid"));
        }

        [Test]
        public async Task Sp0002_PathGetFullPath_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(string value)
    {
        return Path.GetFullPath(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Path.GetFullPath"));
        }

        [Test]
        public async Task Sp0002_PathGetTempPath_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.IO;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod()
    {
        return Path.GetTempPath();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.IO.Path.GetTempPath"));
        }

        [Test]
        public async Task Sp0002_ConfigurationManagerAppSettings_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(
                @"
using System.Configuration;
...
public class TestClass
{
    ...
    public string? TestMethod()
    {
        return ConfigurationManager.AppSettings[""MyKey""];
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Configuration.ConfigurationManager.AppSettings"));
        }

        [Test]
        public async Task Sp0002_ConfigurationManagerConnectionStrings_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(
                @"
using System.Configuration;
...
public class TestClass
{
    ...
    public ConnectionStringSettingsCollection TestMethod()
    {
        return ConfigurationManager.ConnectionStrings;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Configuration.ConfigurationManager.ConnectionStrings"));
        }
...
public class TestClass
{
    ...
    public void TestMethod(object gate)
    {
        Monitor.Exit(gate);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("synchronization"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("threading_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Monitor.Exit"));
        }
...
public class TestClass
{
    ...
    public void TestMethod(Timer timer)
    {
        timer.Start();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Timers.Timer.Start"));
        }
...
public class TestClass
{
    ...
    public void TestMethod(Timer timer)
    {
        timer.Stop();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Timers.Timer.Stop"));
        }
...
public class TestClass
{
    ...
    public void TestMethod(TestHandle handle)
    {
        handle.Dispose();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Runtime.InteropServices.SafeHandle.Dispose"));
        }
...
public class TestClass
{
    ...
    public AssemblyName TestMethod(string path)
    {
        return AssemblyName.GetAssemblyName(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("reflection_environment_source"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("known_impure_namespace_or_type"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Reflection.AssemblyName.GetAssemblyName"));
        }

        public async Task Sp0002_ImmutableQueueDequeue_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Immutable;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public ImmutableQueue<int> TestMethod(ImmutableQueue<int> queue)
    {
        return queue.Dequeue();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Immutable.ImmutableQueue"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("Dequeue"));
        }

        [Test]
        public async Task Sp0002_ImmutableHashSetCreateRangeWithComparer_IsPure()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using System.Collections.Immutable;
...
public class TestClass
{
    ...
    public ImmutableHashSet<int> TestMethod(IEnumerable<int> values, IEqualityComparer<int> comparer)
    {
        ...
        [Test]
        public async Task Sp0002_TypeEqualsType_IsPure()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Type left, Type right)
    {
        ...
        [Test]
        public async Task Sp0002_TypeEqualsObject_IsPure()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public bool TestMethod(Type left, object right)
    {
        ...
        [Test]
        public async Task Sp0002_TypeGetHashCode_IsPure()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
    ...
    public int TestMethod(object left, object right)
    {
        ...
        return object.Equals(left, right) ? 1 : 0;
            ...
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                ...
                (
                    "Synthetic.ComponentModel.AddingNewEventArgs.Constructor.SharpProof.EffectSummary.json",
                ...
                .Concat(CreateSyntheticGeneratedPurityAdditionalFiles(
                    ...
                    (
                        "Synthetic.Object.Equals.Static.SharpProof.EffectSummary.json",
            ...
            var probe = CreateGeneratedPurityProbeContext(source);
            var analyzerOptions = CreateAnalyzerOptions(additionalFiles: additionalFiles);
            var resolutions = ResolveGeneratedPurityByExpressionTexts(
                probe,
                analyzerOptions,
        ...
        [Test]
        public async Task Sp0002_StringReplaceChar_IsPureFromGeneratedPuritySummary()
        {
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                typeof(string).Assembly.Location,
                (
                    "Synthetic.String.Replace.Char.SharpProof.EffectSummary.json",
...
public class TestClass
{
    ...
    public string TestMethod(string input)
    {
        ...
        [Test]
        public async Task Sp0002_StringTrimLastIndexEnumeratorAndSpanViewHelpers_ArePureFromGeneratedPuritySummary()
        {
            var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                typeof(string).Assembly.Location,
                (
                    "Synthetic.String.Trim.Char.SharpProof.EffectSummary.json",
                    "System.String.Trim(char)",
                    "System.String.Trim(char)",
                    "pure",
                    "[]"),
                (
                    "Synthetic.String.TrimStart.Char.SharpProof.EffectSummary.json",
                    "System.String.TrimStart(char)",
                    "System.String.TrimStart(char)",
                    "pure",
                    "[]"),
                (
                    "Synthetic.String.TrimEnd.Char.SharpProof.EffectSummary.json",
                    "System.String.TrimEnd(char)",
                    "System.String.TrimEnd(char)",
                    "pure",
                    "[]"),
                (
                    "Synthetic.String.LastIndexOf.Char.SharpProof.EffectSummary.json",
                    "System.String.LastIndexOf(char)",
                    "System.String.LastIndexOf(char)",
                    "pure",
                    "[]"),
                (
                    "Synthetic.String.GetEnumerator.SharpProof.EffectSummary.json",
                    "System.String.GetEnumerator()",
                    "System.String.GetEnumerator()",
                    "pure",
                    "[]"),
                (
                    "Synthetic.String.ReadOnlySpanView.SharpProof.EffectSummary.json",
...
public class TestClass
{
    ...
    public int TestMethod(string input)
    {
        ...
        [Test]
        public async Task Sp0002_ImmutableStackPop_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Immutable;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public ImmutableStack<int> TestMethod(ImmutableStack<int> stack)
    {
        return stack.Pop();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Immutable.ImmutableStack"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("Pop"));
        }

        [Test]
        public async Task Sp0002_HashSetAdd_UsesGeneratedPurityCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(HashSet<int> values)
    {
        values.Add(1);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.HashSet"));
...
public static class TestClass
{
    public static TimeSpan TestMethod(string value)
    {
        ...
        [Test]
        public async Task Sp0002_CurrentCultureNumericParse_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(double value)
    {
        return value.ToString(""N"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("double.ToString"));
        }

        [Test]
        public async Task Sp0002_CurrentCultureDateParse_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public DateOnly TestMethod(string value)
    {
        return DateOnly.ParseExact(value, ""d"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.DateOnly.ParseExact"));
        }

        [Test]
        public async Task Sp0002_DateTimeOffsetParse_WithInvariantCulture_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
#nullable enable
using System;
...
public class TestClass
{
    ...
    public DateTimeOffset TestMethod(string value)
    {
        return DateTimeOffset.Parse(value, CultureInfo.InvariantCulture);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.DateTimeOffset.Parse"));
        }

        [Test]
        public async Task Sp0002_DateTimeTryParseExact_WithInvariantCulture_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
#nullable enable
using System;
...
public class TestClass
{
    ...
    public bool TestMethod(string value)
    {
        return DateTime.TryParseExact(value, ""O"", CultureInfo.InvariantCulture, DateTimeStyles.None, out _);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.DateTime.TryParseExact"));
        }

        [Test]
        public async Task Sp0002_DateTimeOffsetTryParseExact_WithInvariantCulture_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
#nullable enable
using System;
...
public class TestClass
{
    ...
    public bool TestMethod(string value)
    {
        return DateTimeOffset.TryParseExact(value, ""O"", CultureInfo.InvariantCulture, DateTimeStyles.None, out _);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.DateTimeOffset.TryParseExact"));
        }

        [Test]
        public async Task Sp0002_CurrentCultureDateFormat_UsesSemanticCatalogSource()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(DateTime value)
    {
        return value.ToLongDateString();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("current_culture_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.DateTime.ToLongDateString"));
        }

        [Test]
        public async Task Sp0002_ConfiguredKnownPureGenericMethodOverridesConfiguredImpureType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int[] TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ConfiguredKnownPureGenericValueTypePropertyOverridesConfiguredImpureType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(KeyValuePair<int, int> pair)
    {
        ...
        [Test]
        public async Task Sp0002_ImpureCallee_IncludesCalleeChain()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void Callee()
    {
        Console.WriteLine(""impure"");
            ...
            Assert.That(callerDiagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("catalog_hit"));
            Assert.That(callerDiagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("TestClass.Callee"));
            Assert.That(callerDiagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
        }

        [Test]
        public async Task Sp0002_UnresolvedDelegateTarget_IncludesDistinctCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod(Action action)
    {
        action();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("unresolved_delegate_target"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Action.Invoke"));
        }

        [Test]
        public async Task Sp0002_DynamicDispatch_IncludesDistinctCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod(dynamic value)
    {
        return value.ToString();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("dynamic_dispatch"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityOperationKindProperty], Is.EqualTo("DynamicInvocation"));
        }

        [Test]
        public async Task Sp0002_DynamicBinaryOperation_IncludesDynamicDispatchCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(dynamic value)
    {
        return value + 1;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("dynamic_dispatch"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("BinaryOperationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityOperationKindProperty], Is.EqualTo("Binary"));
        }

        [Test]
        public async Task Sp0002_DynamicUnaryOperation_IncludesDynamicDispatchCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(dynamic value)
    {
        return -value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("dynamic_dispatch"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("UnaryOperationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityOperationKindProperty], Is.EqualTo("Unary"));
        }

        [Test]
        public async Task Sp0002_ClosedWorldInterfaceDispatchWithoutImplementation_UsesDynamicDispatchEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class WorkerHost
{
    ...
    internal int ComputeWithUnknownImplementation(IWorker worker, int value)
    {
        return worker.Compute(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties.ContainsKey(SharpProofDiagnostics.ImpurityCatalogSourceProperty), Is.False);
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("IWorker.Compute"));
        }

        [Test]
        public async Task Sp0002_SourceExternCall_IncludesUnknownExternalCallCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Runtime.InteropServices;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_ProbablyPureShape_IncludesGuessEvidence()
        {
...
public class TestClass
{
    ...
    public int TestMethod(int value)
    {
        return System.Experimental.NumericFacts.Normalize(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("bcl_fallback_probably_pure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("value_return_no_ref_or_out"));
...
public class TestClass
{
    ...
    public int TestMethod(int value)
    {
        return System.Experimental.NumericFacts.Normalize(value);
                ...
                globalOptions: ImmutableDictionary<string, string>.Empty.Add("sharpproof_report_bcl_fallback_guesses", "true"),
                additionalMetadataReferences: ImmutableArray.Create(fixture.Reference));
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_ProbablyImpureShape_IncludesGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public void TestMethod(int value)
    {
        System.Experimental.MutatingSink.WriteMetric(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("bcl_fallback_probably_impure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("probably_impure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("void_returning_metadata_method"));
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_AmbiguousShape_IncludesUnknownGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public System.Experimental.StatefulBox TestMethod(System.Experimental.StatefulBox box)
    {
        return box.Next();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("bcl_fallback_unknown"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("unknown"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("reference_returning_instance_metadata_method"));
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_ValueTypeConstructor_IncludesProbablyPureGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public System.Experimental.NumericStruct TestMethod(int value)
    {
        return new System.Experimental.NumericStruct(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("probably_pure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("value_type_constructor_value_like_parameters"));
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_PropertyGetter_IncludesGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public int TestMethod(System.Experimental.NumericBox box)
    {
        return box.Value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("probably_pure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("metadata_getter_value_like_return"));
        ...
        [Test]
        public async Task Sp0002_MetadataBclFallback_StaticMutableField_IncludesGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return System.Experimental.FieldFacts.MutableValue;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("probably_impure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("mutable_metadata_field"));
        }

        [Test]
        public async Task Sp0002_MetadataBclFallback_InstanceReadonlyField_IncludesGuessEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public int TestMethod(System.Experimental.FieldBox box)
    {
        return box.ReadOnlyValue;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("bcl_heuristic_fallback"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackGuessProperty], Is.EqualTo("probably_pure"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.BclFallbackReasonProperty], Is.EqualTo("readonly_metadata_field_value_like"));
        }

        [Test]
        public async Task Sp0002_MetadataBclFallback_DoesNotOverrideGeneratedSummaryEvidence()
        {
            using var fixture = CreateMetadataOnlyAssemblyFixture(
                "System.FallbackSdk",
                BclFallbackFixtureSource);
...
public class TestClass
{
    ...
    public int TestMethod(int value)
    {
        return System.Experimental.NumericFacts.Normalize(value);
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.NumericFacts.Unknown.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
        ...
        [Test]
        public async Task Sp0002_MutableStateWrite_IncludesDistinctCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        _value = 1;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("AssignmentPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("analyzer.mutation.caller-visible"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass._value"));
        }

        [Test]
        public async Task Sp0002_MutableStateEscape_IncludesSymbolicEscapeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public object TestMethod()
    {
        ...
        return boxed;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_escape"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ReturnStatementPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("owned_local_array_return"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("boxed"));
        }

        [Test]
        public async Task Sp0002_ByRefReturn_IncludesSymbolicEscapeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public ref int GetValue()
    {
        return ref _value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_escape"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ReturnByRefAnalysis"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("analyzer.escape.return.byref"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.GetValue"));
        }

        [Test]
        public async Task Sp0002_AssignmentRhsImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_MutableStateRead_IncludesDistinctCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return s_value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_read"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("FieldReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.s_value"));
        }

        [Test]
        public async Task Sp0002_ContextStaticRead_IncludesDistinctCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_StaticPropertyGetterImpurity_PreservesGetterEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return Value;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("TestClass.Value.get"));
        }

        [Test]
        public async Task Sp0002_StaticConstructorTrigger_PreservesConstructorEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_MethodArgumentImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_LinqArgumentImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using System.Collections.Generic;
...
public class TestClass
{
    ...
    public IEnumerable<int> TestMethod(IEnumerable<int> values)
    {
        ...
        [Test]
        public async Task Sp0002_DirectThrowOnly_IncludesThrowCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        throw new InvalidOperationException();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("throw"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ThrowOperationPurityRule"));
        }

        [Test]
        public async Task Sp0002_ThrowExceptionExpressionImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        throw new InvalidOperationException(Console.ReadLine());
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("catalog_hit"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.ReadLine"));
        }

        [Test]
        public async Task Sp0002_ThrowExpression_IncludesThrowEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(string text)
    {
        ...
        [Test]
        public async Task Sp0002_UnsafePointerOperation_IncludesUnsafePointerCategory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public unsafe int TestMethod()
    {
        ...
        return *pointer;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("unsafe_pointer"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("UnsupportedOperation"));
        }

        [Test]
        public async Task Sp0002_MutualRecursivePurityConservativeDiagnostic_IncludesStructuredEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    private int Bounce(int n)
    {
        ...
        return Fibonacci(n);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("unsupported_operation"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("RecursivePurityAnalysis"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("recursive_call"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.Fibonacci"));
        }

        [Test]
        public async Task Sp0002_ImplicitIndexerWithImpureLengthGetter_PreservesRealCalleeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public sealed class TestClass
{
    ...
    public int TestMethod(Bag bag)
    {
        return bag[^1];
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityOperationKindProperty], Is.EqualTo("Invocation"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("Bag.Length.get"));
        }

        [Test]
        public async Task Sp0002_MutualRecursionWithRealImpurity_PreservesRealCalleeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void B()
    {
        ...
        Console.WriteLine(""impure"");
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("catalog_hit"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("TestClass.B"));
        }
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return Environment.TickCount;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("metadata_only_or_external"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.TickCount"));
        }
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return Environment.CurrentManagedThreadId;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("metadata_only_or_external"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.CurrentManagedThreadId"));
        }
...
public class TestClass
{
    ...
    public long TestMethod()
    {
        return Environment.TickCount64;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("metadata_only_or_external"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.TickCount64"));
        }
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return Environment.ExitCode;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("metadata_only_or_external"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.ExitCode"));
        }

        [Test]
        public async Task Sp0002_EnvironmentExitMethod_UsesGeneratedConservativeUnknownEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        Environment.Exit(1);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("unknown_callee"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.Exit"));
        }
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        return Environment.TickCount;
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.Environment.TickCount.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
        ...
        [Test]
        public async Task Sp0002_EnvironmentStackTrace_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod()
    {
        return Environment.StackTrace;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Environment.StackTrace"));
        }

        [Test]
        public async Task Sp0002_ThreadCurrentThread_UsesGeneratedPuritySummaryEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public Thread TestMethod()
    {
        return Thread.CurrentThread;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Thread.CurrentThread"));
        }
...
public class TestClass
{
    ...
    public Type? TestMethod(string typeName)
    {
        return Type.GetType(typeName);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("reflection_environment_source"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Type.GetType"));
        }

        [Test]
        public async Task Sp0002_TypeFullName_UsesDerivedDispatchEvidenceAfterManualCatalogRemoval()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
#nullable enable
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string? TestMethod(System.Type type)
    {
        return type.FullName;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties.ContainsKey(SharpProofDiagnostics.ImpurityCatalogSourceProperty), Is.False);
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Type.FullName"));
        }

        [Test]
        public async Task Sp0002_TypeTypeHandle_UsesDerivedDispatchEvidenceAfterManualCatalogRemoval()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public RuntimeTypeHandle TestMethod(System.Type type)
    {
        return type.TypeHandle;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties.ContainsKey(SharpProofDiagnostics.ImpurityCatalogSourceProperty), Is.False);
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Type.TypeHandle"));
        }
...
public class TestClass
{
    ...
    public AssemblyLoadContext TestMethod()
    {
        return AssemblyLoadContext.Default;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("reflection_environment_source"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("PropertyReferencePurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("assembly_load_context_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Runtime.Loader.AssemblyLoadContext.Default"));
        }
...
public class TestClass
{
    ...
    public Assembly TestMethod(AssemblyLoadContext context, string path)
    {
        return context.LoadFromAssemblyPath(path);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("assembly_load_context_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Runtime.Loader.AssemblyLoadContext.LoadFromAssemblyPath"));
        }
...
public class TestClass
{
    ...
    public DerivedLoadContext TestMethod()
    {
        return new DerivedLoadContext();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ObjectCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("assembly_load_context_semantic_rule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("DerivedLoadContext.DerivedLoadContext()"));
        }
...
public class TestClass
{
    ...
    public string TestMethod(System.Type type)
    {
        return type.ToString();
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.TypeToString.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
...
public class TestClass
{
    ...
    public string TestMethod(System.Type type)
    {
        return type.ToString();
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.TypeToString.Unknown.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
                            typeof(Type).Assembly.Location,
                            metadataSymbol,
                            "conservative_unknown",
                            "[\"metadata_only_or_external\"]")),
                    new InMemoryAdditionalText(
                        "Synthetic.TypeToString.Pure.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
                            typeof(Type).Assembly.Location,
                            metadataSymbol,
                            "pure",
...
public class TestClass
{
    ...
    public string TestMethod(System.Type type)
    {
        return $""{type}"";
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.TypeToString.Interpolation.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
                            typeof(Type).Assembly.Location,
                            metadataSymbol,
                            "pure",
...
public class TestClass
{
    ...
    public string TestMethod(System.SyntheticSystemFormattingBoundary value)
    {
        return $""{value}"";
                    ...
                    additionalFiles: ImmutableArray.Create<AdditionalText>(
                        new InMemoryAdditionalText(
                            "Synthetic.SystemFormattingBoundary.Unknown.SharpProof.EffectSummary.json",
                            CreatePuritySummaryJson(
                                assemblyPath,
                ...
                Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
                Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("metadata_only_or_external"));
                Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.SyntheticSystemFormattingBoundary.ToString"));
            }
            finally
            {
...
public class TestClass
{
    ...
    public Type TestMethod(RuntimeTypeHandle handle)
    {
        return Type.GetTypeFromHandle(handle);
                ...
                additionalFiles: ImmutableArray.Create<AdditionalText>(
                    new InMemoryAdditionalText(
                        "Synthetic.TypeGetTypeFromHandle.SharpProof.EffectSummary.json",
                        CreatePuritySummaryJson(
                            typeof(Type).Assembly.Location,
                            metadataSymbol,
                            "pure",
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        Monitor.Enter(Gate);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("synchronization"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Threading.Monitor.Enter"));
        }

        [Test]
        public async Task Sp0002_MutableCollectionCreation_IncludesCatalogEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public List<int> TestMethod()
    {
        return new List<int>();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ObjectCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generated_purity_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Collections.Generic.List<int>.List()"));
        }

        [Test]
        public async Task Sp0002_VariableInitializerImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_SpreadOperandImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using System.Collections.Immutable;
...
public class TestClass
{
    ...
    public ImmutableArray<int> Extend()
    {
        return [.. GetValues(), 42];
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("TestClass.GetValues"));
        }

        [Test]
        public async Task Sp0002_DirectArrayCreation_IncludesArrayCreationEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int[] TestMethod()
    {
        return new int[1];
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ArrayCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("array_creation"));
        }

        [Test]
        public async Task Sp0002_GenericTypeConstruction_IncludesObjectCreationEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass<T> where T : new()
{
    ...
    public T TestMethod()
    {
        return new T();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("unsupported_operation"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("ObjectCreationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityOperationKindProperty], Is.EqualTo("TypeParameterObjectCreation"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("generic_type_construction"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("T"));
        }

        [Test]
        public async Task Sp0002_ArrayElementImpureArrayReference_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    private int[] GetValues()
    {
        ...
        [Test]
        public async Task Sp0002_ArrayInitializerElementImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int[] TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ArrayDimensionImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_UserDefinedConversionImpurity_PreservesOperatorEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int TestMethod(Wrapped value)
    {
        ...
        [Test]
        public async Task Sp0002_UserDefinedBinaryOperatorImpurity_PreservesOperatorEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public Wrapped TestMethod(Wrapped left, Wrapped right)
    {
        ...
        [Test]
        public async Task Sp0002_UserDefinedUnaryOperatorImpurity_PreservesOperatorEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public Wrapped TestMethod(Wrapped value)
    {
        ...
        [Test]
        public async Task Sp0002_UsingDisposeImpurity_PreservesDisposeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        using (var resource = new Resource())
        {
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("Resource.Dispose"));
        }

        [Test]
        public async Task Sp0002_ConstructorInitializerImpurity_PreservesConstructorEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class DerivedType : BaseType
{
        ...
        : base()
    {
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("BaseType.BaseType"));
        }

        [Test]
        public async Task Sp0002_DelegateCreationImpurity_IncludesTargetCalleeChain()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        action();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("MethodInvocationPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("System.Console.WriteLine"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCalleeChainProperty], Does.Contain("TestClass.ImpureTarget"));
        }

        [Test]
        public async Task Sp0002_EventAssignment_IncludesMutableStateWriteEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        Changed += Handler;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("EventAssignmentPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("event_subscription"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpuritySymbolProperty], Does.Contain("TestClass.Changed"));
        }

        [Test]
        public async Task Sp0002_InterpolatedStringExpressionImpurity_PreservesOriginalEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public string TestMethod()
    {
        ...
        [Test]
        public async Task Sp0002_ArrayCollectionExpression_IncludesTargetEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public int[] TestMethod()
    {
        return [1, 2, 3];
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCategoryProperty], Is.EqualTo("mutable_state_write"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityRuleProperty], Is.EqualTo("CollectionExpressionPurityRule"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ImpurityCatalogSourceProperty], Is.EqualTo("collection_expression_target"));
        }

        [Test]
        public async Task Sp0009_IsOnlyEmittedWhenExplanationsAreEnabled()
        {
            var source = @"
using System;
using SharpProof.Attributes;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_ExceptionSummary_IsOptIn()
        {
            var source = @"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_RuntimeHazardModeSites_ReportsDefiniteHazardWithoutPurityAttribute()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value)
    {
        ...
        [Test]
        public async Task Sp0010_RuntimeHazardModeAll_ReportsSummaryAndSite()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_RuntimeHazardModeAll_ReportsCountIndexSummaryAndSiteEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Collections.Generic;
...
public class TestClass
{
    public int TestMethod(List<int> values)
    {
        ...
        return 0;
            ...
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentOutOfRangeException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_count_index_out_of_range"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.ArgumentOutOfRangeException=definite_count_index_out_of_range:count_index"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentOutOfRangeException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_count_index_out_of_range"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.ArgumentOutOfRangeException=definite_count_index_out_of_range:count_index"));
        }

        [Test]
        public async Task Sp0010_RuntimeHazardModeAll_ReportsArrayGetValueSummaryAndSiteEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod()
    {
        ...
        return (int)values.GetValue(0)!;
            ...
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.IndexOutOfRangeException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_array_get_value_index_out_of_range"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.IndexOutOfRangeException=definite_array_get_value_index_out_of_range:array_get_value"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.IndexOutOfRangeException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_array_get_value_index_out_of_range"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.IndexOutOfRangeException=definite_array_get_value_index_out_of_range:array_get_value"));
        }

        [Test]
        public async Task Sp0010_RuntimeHazardModeAll_ReportsSwitchNoMatchSummaryAndSiteEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value)
    {
        ...
        return 0;
            ...
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.Runtime.CompilerServices.SwitchExpressionException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_switch_expression_no_match"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.Runtime.CompilerServices.SwitchExpressionException=definite_switch_expression_no_match:switch_expression"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.Runtime.CompilerServices.SwitchExpressionException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_switch_expression_no_match"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.Runtime.CompilerServices.SwitchExpressionException=definite_switch_expression_no_match:switch_expression"));
        }

        [Test]
        public async Task Sp0010_RuntimeHazardModeAll_ReportsNegativeStackAllocSummaryAndSiteEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public int TestMethod(int length)
    {
        ...
        return 0;
            ...
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.OverflowException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_negative_stackalloc_length"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.OverflowException=definite_negative_stackalloc_length:stackalloc_length"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.OverflowException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_negative_stackalloc_length"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.OverflowException=definite_negative_stackalloc_length:stackalloc_length"));
        }

        [Test]
        public async Task Sp0011_RuntimeHazardModeSites_UsesPathFactsToSuppressGuardedHazard()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value, int divisor)
    {
        ...
        [Test]
        public async Task Sp0010_DirectThrows_ReportsExceptionTypes()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public string TestMethod(string? value)
    {
        ...
        return value.Length > 0 ? value : throw new InvalidOperationException();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentNullException;System.InvalidOperationException"));
        }

        [Test]
        public async Task Sp0010_CaughtThrow_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_NestedLambdaThrow_IsNotReportedOnOuterMethod()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public Func<int> TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_SourceCalleeThrow_PropagatesToCaller()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Callee()
    {
        throw new InvalidOperationException();
            ...
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'Caller'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'Callee'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
        }

        [Test]
        public async Task Sp0010_SourceCalleeThrow_CaughtByCaller_IsSuppressedOnCaller()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Callee()
    {
        ...
        [Test]
        public async Task Sp0010_SourceConstructorThrow_PropagatesToFactory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class Widget
{
    public Widget()
    {
        throw new InvalidOperationException();
            ...
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'Create'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'.ctor'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
        }

        [Test]
        public async Task Sp0010_SourceConstructorThrow_CaughtAtCreation_IsSuppressedOnFactory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class Widget
{
    public Widget()
    {
        ...
        [Test]
        public async Task Sp0010_SourcePropertyGetterThrow_PropagatesToReader()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class Widget
{
    public int Value
    {
        get
        {
            ...
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'Read'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(exceptionDiagnostics.Single(d => d.GetMessage().Contains("'get_Value'", StringComparison.Ordinal)).Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
        }

        [Test]
        public async Task Sp0010_SourcePropertyGetterThrow_CaughtAtRead_IsSuppressedOnReader()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class Widget
{
    public int Value
    {
        ...
        [Test]
        public async Task Sp0010_EffectSummaryLibraryCall_PropagatesToCaller()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod(object value)
    {
        ArgumentNullException.ThrowIfNull(value);
            ...
            var diagnostic = SingleDiagnostic(diagnostics.Where(d => d.Id == SharpProofDiagnostics.ExceptionSummaryId).ToImmutableArray(), SharpProofDiagnostics.ExceptionSummaryId);

            Assert.That(diagnostic.GetMessage(), Does.Contain("'TestMethod'"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentNullException"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.ArgumentNullException=effect_summary:System.ArgumentNullException.ThrowIfNull"));
        ...
        [Test]
        public async Task Sp0010_EffectSummaryLibraryCall_CaughtAtCallSite_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod(object value)
    {
        ...
        [Test]
        public async Task Sp0011_EffectSummaryLibraryCall_UncaughtAtCallSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod(object value)
    {
        ArgumentNullException.ThrowIfNull(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.ArgumentNullException=effect_summary:System.ArgumentNullException.ThrowIfNull"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("System.ArgumentNullException.ThrowIfNull"));
            AssertExceptionEdgesPropertyContainsIfPresent(
                diagnostic,
                "System.ArgumentNullException",
                "System.ArgumentNullException.ThrowIfNull");
        ...
        [Test]
        public async Task Sp0011_EffectSummaryGuardHelperChain_UncaughtAtCallSite_ReportsRecursiveExceptionSet()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod(string text)
    {
        ...
        [Test]
        public async Task Sp0011_EffectSummaryLibraryCall_CaughtAtCallSite_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod(object value)
    {
        ...
        [Test]
        public async Task Sp0010AndSp0011_EffectSummaryLibraryCall_PartiallyCaughtAtCallSite_ReportsOnlyEscapingType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
    ...
    public void TestMethod(object value)
    {
        ...
        catch (ArgumentNullException)
        {
            ...
            var summaryDiagnostic = SingleDiagnostic(
                diagnostics.Where(d => d.Id == SharpProofDiagnostics.ExceptionSummaryId).ToImmutableArray(),
                SharpProofDiagnostics.ExceptionSummaryId);
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=effect_summary:System.ArgumentNullException.ThrowIfNull"));

            var siteDiagnostic = SingleDiagnostic(
                diagnostics.Where(d => d.Id == SharpProofDiagnostics.UncaughtExceptionSiteId).ToImmutableArray(),
                SharpProofDiagnostics.UncaughtExceptionSiteId);
            Assert.That(siteDiagnostic.GetMessage(), Does.Contain("ArgumentNullException.ThrowIfNull(value)"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=effect_summary:System.ArgumentNullException.ThrowIfNull"));
        }

        [Test]
        public async Task Sp0011_EffectSummaryConstructor_UncaughtAtCallSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public Uri Create(string value)
    {
        return new Uri(value);
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.UriFormatException"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("System.Uri"));
        }

        [Test]
        public async Task Sp0011_EffectSummaryConstructor_CaughtAtCallSite_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public Uri? Create(string value)
    {
        ...
        [Test]
        public async Task Sp0010AndSp0011_EffectSummaryConstructorInitializer_PropagateToDerivedConstructor()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
        ...
        : base(value)
    {
            ...
            var summaryDiagnostic = SingleDiagnostic(
                diagnostics
                    ...
                    .Where(d => (d.Properties[SharpProofDiagnostics.ExceptionSourcesProperty] ?? string.Empty).Contains("System.Exception", StringComparison.Ordinal))
                    .ToImmutableArray(),
                SharpProofDiagnostics.ExceptionSummaryId);
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.Exception"));
            ...
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("System.Exception"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.Exception"));
        }

        [Test]
        public async Task Sp0011_SourceCallee_UncaughtAtCallSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Callee()
    {
        throw new InvalidOperationException();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("source_callee"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=source_callee:"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("Callee"));
        }

        [Test]
        public async Task Sp0011_SourceCallee_AwaitNullPropagation_PreservesAwaitNullSourceEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System.Threading.Tasks;
...
public class TestClass
{
    ...
    private async Task<int> Callee()
    {
        ...
        return await task;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("source_callee"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.NullReferenceException=source_callee:"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("Callee()"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("definite_await_null:await_expression"));
        }

        [Test]
        public async Task Sp0011_SourceCallee_LocalFunctionPropagation_EmitsExceptionEdges()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_SourceCallee_LambdaPropagation_EmitsExceptionEdges()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_SourceCallee_CaughtAtCallSite_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Callee()
    {
        ...
        [Test]
        public async Task Sp0010AndSp0011_SourceConstructorInitializer_PropagateToDerivedConstructor()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
        ...
        : base(value)
    {
            ...
            var summaryDiagnostic = SingleDiagnostic(
                diagnostics
                    ...
                    .Where(d => (d.Properties[SharpProofDiagnostics.ExceptionSourcesProperty] ?? string.Empty).Contains("BaseClass", StringComparison.Ordinal))
                    .ToImmutableArray(),
                SharpProofDiagnostics.ExceptionSummaryId);
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("source_callee"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("BaseClass"));
            Assert.That(summaryDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("direct_throw:throw"));
            ...
            var siteDiagnostic = SingleDiagnostic(
                ...
                SharpProofDiagnostics.UncaughtExceptionSiteId);
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("source_callee"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("BaseClass"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("BaseClass"));
            Assert.That(siteDiagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("direct_throw:throw"));
        }

        [Test]
        public async Task Sp0011_InterfaceMethodDispatch_AliasLocalExactConcreteReceiver_ReportsSourceCalleeEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        alias.Work();
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("source_callee"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.InvalidOperationException=source_callee:"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("ThrowingService.Work"));
        }

        [Test]
        public async Task Sp0011_DirectThrow_UncaughtAtSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_DefiniteDivideByZero_UncaughtAtSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value)
    {
        return value / 0;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.DivideByZeroException"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("definite_divide_by_zero"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.DivideByZeroException=definite_divide_by_zero:binary_operator"));
        }

        [Test]
        public async Task Sp0011_DefiniteNullDereference_UncaughtAtSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_DefiniteDivideByZero_Caught_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public int TestMethod(int value)
    {
        ...
        [Test]
        public async Task Sp0011_DefiniteNullDereference_Caught_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0011_SourceCallee_MultiHopChain_PreservesRecursiveSourceEvidence()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Inner()
    {
        ...
        [Test]
        public async Task Sp0010_EffectSummaryConstructor_PropagatesToFactory()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public Uri Create(string value)
    {
        ...
        [Test]
        public async Task Sp0010_EffectSummaryPropertyGetter_PropagatesToReader()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public string Read()
    {
        ...
        [Test]
        public async Task Sp0011_EffectSummaryPropertyGetter_UncaughtAtAccessSite_ReportsWarning()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public string Read()
    {
        return Environment.CurrentDirectory;
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.InvalidOperationException"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("effect_summary"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSymbolProperty], Does.Contain("System.Environment.CurrentDirectory.get"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Does.Contain("System.Environment.CurrentDirectory.get"));
        }

        [Test]
        public async Task Sp0010_RethrowTypedCatch_ReportsCaughtExceptionType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Dangerous()
    {
        ...
        [Test]
        public async Task Sp0010_RethrowTypedCatch_CaughtByOuterTry_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Dangerous()
    {
        ...
        [Test]
        public async Task Sp0010_RethrowUntypedCatchInsideTypedCatch_ReportsUnknownExceptionType()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    ...
    private void Dangerous()
    {
        ...
        [Test]
        public async Task Sp0010_ConstantIntegerDivideByZero_ReportsDivideByZeroException()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value)
    {
        ...
        [Test]
        public async Task Sp0010_ConstantDecimalModuloByZero_Caught_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public decimal TestMethod(decimal value)
    {
        ...
        [Test]
        public async Task Sp0010_FloatingPointDivideByZero_DoesNotReport()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public double TestMethod(double value)
    {
        ...
        [Test]
        public async Task Sp0010_IfBranchZeroDivisor_ReportsDivideByZeroException()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value, int divisor)
    {
        ...
        [Test]
        public async Task Sp0010_IfElseNonZeroCondition_ReportsDivideByZeroExceptionInElse()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(int value, int divisor)
    {
        ...
        [Test]
        public async Task Sp0010_DirectNullMemberAccess_ReportsNullReferenceException()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_IfBranchNullReceiver_ReportsNullReferenceException()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(string value)
    {
        ...
        [Test]
        public async Task Sp0010_IfBranchNullReceiver_ReassignedBeforeUse_DoesNotReport()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
    public int TestMethod(string value)
    {
        ...
        [Test]
        public async Task Sp0010_DirectThrow_IncludesStructuredEvidenceProperties()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_FinallyThrow_ShadowsEarlierEscapingThrow()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        finally
        {
            ...
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentNullException"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("direct_throw"));
            Assert.That(diagnostic.Properties[SharpProofDiagnostics.ExceptionSourcesProperty], Is.EqualTo("System.ArgumentNullException=direct_throw:throw"));
        }

        [Test]
        public async Task Sp0011_FinallyThrow_ShadowsEarlierEscapingThrowSite()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public void TestMethod()
    {
        ...
        finally
        {
            ...
            Assert.That(siteDiagnostics[0].Properties[SharpProofDiagnostics.ExceptionTypesProperty], Is.EqualTo("System.ArgumentNullException"));
            Assert.That(siteDiagnostics[0].Properties[SharpProofDiagnostics.ExceptionCategoriesProperty], Is.EqualTo("direct_throw"));
        }

        [Test]
        public async Task Sp0010_DefaultReferenceMemberAccess_Caught_IsSuppressed()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
using System;
...
public class TestClass
{
    public int TestMethod()
    {
        ...
        [Test]
        public async Task Sp0010_NullConditionalAccess_DoesNotReportNullReferenceException()
        {
            var diagnostics = await GetAnalyzerDiagnosticsAsync(@"
public class TestClass
{
