...
[TestFixture]
[NUnit.Framework.Category("SmtHeavy")]
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, catalogSource: "generated_purity_summary",
            symbolContains: "System.Console.WriteLine");
    }
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, catalogSource: "generated_purity_summary",
            symbolContains: "System.Console.Clear");
    }
...
public class TestClass
{
    ...
    public TypeConverter TestMethod(Type type)
    {
        ...
        AssertSp0002Evidence(diagnostic, "global_state_write", "MethodInvocationPurityRule", "generated_purity_summary",
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, "unknown_callee", "MethodInvocationPurityRule", "generated_purity_summary",
            "System.GC.Collect");
    }
...
public class TestClass
{
    ...
    public int TestMethod(object value)
    {
        ...
        AssertSp0002Evidence(diagnostic, "metadata_only_or_external", "MethodInvocationPurityRule",
            "generated_purity_summary", "System.GC.GetGeneration");
    }
...
public class TestClass
{
    ...
    public Random TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "random_semantic_rule",
            symbolContains: "System.Random.Random");
    }
...
public class TestClass
{
    ...
    public int TestMethod(Random random)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "random_semantic_rule",
            symbolContains: "System.Random.Next");
    }
...
public class TestClass
{
    ...
    public void TestMethod(StringBuilder sb)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "string_builder_semantic_rule",
            symbolContains: "System.Text.StringBuilder.Append");
    }
...
public class TestClass
{
    ...
    public void TestMethod(int[] values)
    {
        ...
        AssertSp0002Evidence(diagnostic, rule: "MethodInvocationPurityRule",
            catalogSource: "array_mutation_semantic_rule", symbolContains: "System.Array.Reverse");
    }
...
public class TestClass
{
    ...
    public void TestMethod(int[] values, Comparison<int> comparison)
    {
        ...
        AssertSp0002Evidence(diagnostic, rule: "MethodInvocationPurityRule",
            catalogSource: "array_mutation_semantic_rule", symbolContains: "System.Array.Sort");
    }
...
public class TestClass
{
    ...
    public XDocument TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", "MethodInvocationPurityRule", "xml_linq_semantic_rule",
...
public class TestClass
{
    ...
    public string TestMethod(XElement element)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", "PropertyReferencePurityRule", "xml_linq_semantic_rule",
...
public class TestClass
{
    ...
    public MemoryStream TestMethod()
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", "ObjectCreationPurityRule", "io_stream_text_semantic_rule",
...
public class TestClass
{
    ...
    public string TestMethod(StringReader reader)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "io_stream_text_semantic_rule",
            symbolContains: "System.IO.StringReader.ReadToEnd");
    }
...
public class TestClass
{
    ...
    public void TestMethod(StreamWriter writer)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "io_stream_text_semantic_rule",
            symbolContains: "System.IO.StreamWriter.WriteLine");
    }
...
public class TestClass
{
    ...
    public void TestMethod(StringWriter writer)
    {
        ...
        AssertSp0002Evidence(diagnostic, "catalog_hit", catalogSource: "io_stream_text_semantic_rule",
            symbolContains: "System.IO.StringWriter.Write");
    }
...
public class TestClass
{
    ...
    public byte[] TestMethod(ReadOnlySpan<byte> data)
    {
        ...
        Assert.That(resolution.Matched, Is.True,
            "Generated purity catalog should trust the exact SHA256.ReadOnlySpan<byte> overload.");
    }
...
public class TestClass
{
    ...
    public bool TestMethod(string value)
    {
        ...
        Assert.That(resolution.Matched, Is.True,
            "Generated purity catalog should resolve Uri.IsWellFormedUriString to its runtime implementation assembly.");
    }
...
public class TestClass
{
    ...
    public bool TestMethod()
    {
        ...
        Assert.That(matched, Is.True,
            "Generated purity catalog should resolve OperatingSystem.IsWindows to its runtime implementation assembly.");
    }
...
public class TestClass
{
    ...
    public bool TestMethod(IPAddress address)
    {
        ...
        Assert.That(matched, Is.True,
            "Generated purity catalog should resolve IPAddress.IsLoopback(System.Net.IPAddress).");
        Assert.That(classification, Is.EqualTo("pure"),
...
public class TestClass
{
    ...
    public FrameworkName TestMethod()
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
            typeof(FrameworkName).Assembly.Location,
            (
...
public class TestClass
{
    ...
    public AggregateException Flatten(AggregateException value)
    {
        ...
        Assert.That(
            classifications[
                    "System.AggregateException.AggregateException(System.Collections.Generic.IEnumerable<System.Exception>)"]
                .classification, Is.EqualTo("impure"),
...
public class TestClass
{
    ...
    public bool TestMethod(int? left, int? right)
    {
        ...
        Assert.That(classifications["Nullable.Compare(left, right)"].classification,
            Is.EqualTo("conservative_unknown"));
...
public class TestClass
{
    ...
    public int TestMethod(bool left, bool right, char value, char other)
    {
        ...
        {
            Assert.That(resolutions[expressionText].matched, Is.True,
                "Generated purity catalog should resolve " + expressionText + ".");
...
public class TestClass
{
    ...
    public List<int> EnumerableMethod(IEnumerable<int> values)
    {
        ...
        Assert.That(impuritySymbols,
            Has.Some.Contain("System.Collections.Generic.List<int>.List(System.Collections.Generic.IEnumerable<int>)"));
...
public class TestClass
{
    ...
    public Span<int> ViewItems(List<int> values)
    {
        ...
        {
            Assert.That(resolutions[expression].matched, Is.True,
                $"Generated purity catalog should resolve {expression}.");
            Assert.That(resolutions[expression].classification, Is.EqualTo("impure"),
                $"{expression} should remain generated impure.");
        }
    }
...
public class TestClass
{
    ...
    public int[] StackMethod(Stack<int> stack)
    {
        ...
        Assert.That(resolutions["queue.ToArray()"],
            Is.EqualTo((true, "pure", "fresh_array_candidate_via_local_helpers")));
        Assert.That(resolutions["stack.ToArray()"],
            Is.EqualTo((true, "impure", "fresh_array_candidate_requires_non_pure_resolution")));
    }
...
public class TestClass
{
    ...
    public int DequeueMethod(PriorityQueue<int, int> queue)
    {
        ...
        Assert.That(classifications["System.Collections.Generic.PriorityQueue<TElement, TPriority>.Dequeue()"],
            Is.EqualTo((true, "impure")));
    }
...
public class TestClass
{
    ...
    public bool TryDequeueMethod(ConcurrentQueue<int> queue)
    {
        ...
        Assert.That(classifications["System.Collections.Concurrent.ConcurrentQueue<T>.Enqueue(T)"],
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Collections.Concurrent.ConcurrentQueue<T>.TryDequeue(out T)"],
            Is.EqualTo((true, "impure")));
    }
...
public class TestClass
{
    ...
    public bool BagTryTakeMethod(ConcurrentBag<int> bag)
    {
        ...
        Assert.That(
            ...
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Collections.Concurrent.BlockingCollection<T>.Add(T)"],
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Collections.Concurrent.BlockingCollection<T>.Take()"],
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Collections.Concurrent.ConcurrentBag<T>.Add(T)"],
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Collections.Concurrent.ConcurrentBag<T>.TryTake(out T)"],
            Is.EqualTo((true, "impure")));
    }
...
public class TestClass
{
    ...
    public MethodBase? StackFrameMethod(StackFrame stackFrame)
    {
        ...
        Assert.That(classifications["System.Diagnostics.DiagnosticListener.DiagnosticListener(string)"],
            Is.EqualTo((true, "impure")));
    ...
    public void BitArrayMethod(BitArray bits)
    {
        ...
        var trackedMembers = new (string Label, IMethodSymbol Symbol)[]
        {
            ("System.Collections.Generic.SortedDictionary<TKey, TValue>.Add(TKey, TValue)",
                sortedDictionaryAdd.OriginalDefinition),
...
public class TestClass
{
    ...
    public void SortRangeMethod(int[] values, IComparer<int> comparer)
    {
        ...
        Assert.That(
            ...
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Array.Sort<T>(T[], System.Collections.Generic.IComparer<T>?)"],
            Is.EqualTo((true, "impure")));
        Assert.That(classifications["System.Array.Sort<T>(T[], int, int, System.Collections.Generic.IComparer<T>?)"],
            Is.EqualTo((true, "impure")));
    }
...
public class TestClass
{
    ...
    public bool ImpureHelper(MemberInfo member, Type attributeType)
    {
        ...
        {
            ("System.Attribute.GetCustomAttribute(System.Reflection.MemberInfo, System.Type)",
                getCustomAttribute.OriginalDefinition),
            ("System.Attribute.GetCustomAttributes(System.Reflection.MemberInfo)",
                getCustomAttributes.OriginalDefinition),
            ("System.Attribute.IsDefined(System.Reflection.MemberInfo, System.Type)", isDefined.OriginalDefinition),
            ("System.Reflection.CustomAttributeData.GetCustomAttributes(System.Reflection.MemberInfo)",
                getCustomAttributesData.OriginalDefinition)
        };
        var classifications = trackedMembers.ToDictionary(
            entry => entry.Label,
            entry =>
...
public class TestClass
{
    ...
    public long ToFileTimeMethod(DateTime value)
    {
        ...
        Assert.That(resolutions.Select(result => result.classification).ToArray(),
            Is.EqualTo(new[] { "impure", "impure" }),
...
public class TestClass
{
    ...
    public RegularExpressionAttribute TestMethod()
    {
        ...
        Assert.That(resolution.Matched, Is.True,
            "Generated purity catalog should resolve RegularExpressionAttribute..ctor(string).");
        Assert.That(resolution.Classification, Is.EqualTo("impure"),
...
public class TestClass
{
    ...
    public RangeAttribute RangeMethod()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(new[] { "ObjectCreationPurityRule" }));
        Assert.That(impuritySymbols,
            Has.Some.Contain("System.ComponentModel.DataAnnotations.RequiredAttribute.RequiredAttribute()"));
        Assert.That(impuritySymbols,
            Has.Some.Contain("System.ComponentModel.DataAnnotations.StringLengthAttribute.StringLengthAttribute(int)"));
        Assert.That(impuritySymbols,
            Has.Some.Contain("System.ComponentModel.DataAnnotations.RangeAttribute.RangeAttribute(double, double)"));
...
public class TestClass
{
    ...
    public int FindIndexMethod(int[] values)
    {
        ...
        Assert.That(classifications["Array.Find(values, static value => value > 0)"].classification,
            Is.EqualTo("impure"),
        ...
        Assert.That(classifications["Array.FindIndex(values, static value => value > 0)"].classification,
            Is.EqualTo("pure"),
...
public class TestClass
{
    ...
    public bool TrueForAllMethod(int[] values)
    {
        ...
        Assert.That(classifications["Array.Exists(values, static value => value > 0)"].classification,
            Is.EqualTo("pure"),
        ...
        Assert.That(classifications["Array.TrueForAll(values, static value => value > 0)"].classification,
            Is.EqualTo("pure"),
...
public class TestClass
{
    ...
    public int TestMethod(Array values, object target)
    {
        ...
        var trackedMethods = syntaxTree.GetRoot()
            ...
            .Where(node =>
                (node is InvocationExpressionSyntax invocation &&
                 invocation.ToString() == "Array.IndexOf(values, target)") ||
            ...
            .Select(node => node switch
            {
                ...
                MemberAccessExpressionSyntax => (semanticModel.GetSymbolInfo(node).Symbol as IPropertySymbol)
                    ?.GetMethod,
                _ => null
            })
            .Where(method => method is not null)
...
public class TestClass
{
    ...
    public int TestMethod(SortedList<int, int> values, int key, LinkedListNode<int> node)
    {
        ...
        Assert.That(
            classifications["System.Collections.Generic.SortedList<TKey, TValue>.IndexOfKey(TKey)"].classification,
            Is.EqualTo("pure"),
        ...
        Assert.That(classifications["System.Collections.Generic.LinkedListNode<T>.Value.get"].classification,
            Is.EqualTo("pure"),
...
public class TestClass
{
    ...
    public void SetNodeValueMethod(LinkedListNode<int> node, int value)
    {
        ...
        Assert.That(classifications["System.Collections.Generic.LinkedList<T>.AddFirst(T)"].classification,
            Is.EqualTo("impure"),
            "Generated purity catalog should classify LinkedList<T>.AddFirst(T) as impure.");
        Assert.That(classifications["System.Collections.Generic.LinkedList<T>.AddFirst(T)"].primaryCategory,
            Is.EqualTo("impure_callee"),
        ...
        Assert.That(classifications["System.Collections.Generic.LinkedListNode<T>.Value.set"].classification,
            Is.EqualTo("impure"),
            "Generated purity catalog should classify LinkedListNode<T>.Value.set as impure.");
        Assert.That(classifications["System.Collections.Generic.LinkedListNode<T>.Value.set"].primaryCategory,
...
public class TestClass
{
    ...
    public bool TestMethod(SortedDictionary<int, string> values, int key, string target)
    {
        ...
        Assert.That(
            classifications["System.Collections.Generic.SortedDictionary<TKey, TValue>.ContainsKey(TKey)"].matched,
            Is.True,
            "Generated purity catalog should resolve SortedDictionary<TKey, TValue>.ContainsKey.");
        Assert.That(
            classifications["System.Collections.Generic.SortedDictionary<TKey, TValue>.ContainsKey(TKey)"]
                .classification, Is.EqualTo("impure"),
            "Generated purity catalog should capture the runtime summary classification for SortedDictionary<TKey, TValue>.ContainsKey.");
        Assert.That(
            classifications["System.Collections.Generic.SortedDictionary<TKey, TValue>.ContainsValue(TValue)"].matched,
            Is.True,
            "Generated purity catalog should resolve SortedDictionary<TKey, TValue>.ContainsValue.");
        Assert.That(
            classifications["System.Collections.Generic.SortedDictionary<TKey, TValue>.ContainsValue(TValue)"]
                .classification, Is.EqualTo("impure"),
        ...
        Assert.That(
            classifications["System.Collections.Generic.SortedDictionary<TKey, TValue>.TryGetValue(TKey, out TValue)"]
                .matched, Is.True,
...
public class TestClass
{
    ...
    public bool TestMethod(ICollection<int> collection, IList<int> list, int value)
    {
        ...
        Assert.That(classifications["System.Collections.Generic.ICollection<T>.Contains(T)"].classification,
            Is.EqualTo("conservative_unknown"),
        ...
        Assert.That(classifications["System.Collections.Generic.ICollection<T>.Count.get"].classification,
            Is.EqualTo("conservative_unknown"),
        ...
        Assert.That(classifications["System.Collections.Generic.IList<T>.IndexOf(T)"].classification,
            Is.EqualTo("conservative_unknown"),
...
public class TestClass
{
    ...
    public int TestMethod(IEnumerable<int> values, IEnumerator<int> enumerator)
    {
        ...
        Assert.That(classifications["System.Collections.Generic.IEnumerable<T>.GetEnumerator()"].classification,
            Is.EqualTo("conservative_unknown"),
        ...
        Assert.That(classifications["System.Collections.Generic.IEnumerator<T>.Current.get"].classification,
            Is.EqualTo("conservative_unknown"),
...
public class TestClass
{
    ...
    public object GetKey(SortedList values, int index)
    {
        ...
        Assert.That(classifications["System.Collections.Hashtable.ContainsKey(object)"].classification,
            Is.EqualTo("impure"));
        Assert.That(classifications["System.Globalization.CompareInfo.Compare(string, string)"].matched, Is.True);
        Assert.That(classifications["System.Globalization.CompareInfo.Compare(string, string)"].classification,
            Is.EqualTo("pure"));
...
public class TestClass
{
    ...
    public int TestMethod(object left, object right)
    {
        ...
        var additionalFiles = CreateSyntheticGeneratedPurityAdditionalFiles(
                typeof(AddingNewEventArgs).Assembly.Location,
                (
...
public static class TestClass
{
    public static TimeSpan TestMethod(string value)
    {
        ...
        Assert.That(matched, Is.True,
            "The deterministic parse helper should recognize span ParseExact with InvariantCulture and None styles.");
    }
...
public class TestClass
{
    ...
    [Test]
    public async Task
        GeneratedPuritySummary_Reports_InterpolatedSystemToString_WhenMetadataEvidenceIsConservativeUnknown()
    {
...
namespace System
{
    public sealed class SyntheticSystemFormattingBoundary
    {
        ...
        try
        {
            ...
            var boundarySyntaxTree =
                CSharpSyntaxTree.ParseText(boundarySource, new CSharpParseOptions(LanguageVersion.Preview));
...
public class TestClass
{
    ...
    private void Callee()
    {
        ...
        Assert.That(
            siteDiagnostics.Any(d =>
                d.GetMessage().Contains("throw new InvalidOperationException()", StringComparison.Ordinal)), Is.True);
    }
