...
public sealed class SymbolicCfgSupportTests {
    ...
    public void ExactCfgState_IsRoutedWithoutApproximation() {
        ...
        var lowered = SymbolicCfgProgramPointStateCollector.CollectState(site, fixture.SemanticModel, CancellationToken.None, null, false);
        var routed = SymbolicReachabilityService.CollectPathStateAt(site, fixture.SemanticModel, CancellationToken.None);
    ...
    public void UnsupportedCfgState_ProducesUnknownProof() {
        ...
        var lowered = SymbolicCfgProgramPointStateCollector.CollectForInitialEntryState(loop, fixture.SemanticModel,
            CancellationToken.None);
        var routed = SymbolicReachabilityService.CollectForInitialEntryState(loop, fixture.SemanticModel, CancellationToken.None);
