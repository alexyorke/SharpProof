...
namespace SharpProof.Test
{
    internal static class ReadmeExampleFixture
    {
        ...
        public static async Task<(int ExitCode, string StandardOutput, string StandardError)> RunReadmeGeneratorAsync(bool verifyOnly)
        {
            ...
            using var process = Process.Start(startInfo) ?? throw new InvalidOperationException("Failed to start README generator.");
