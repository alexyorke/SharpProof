...
public sealed class SymbolicCliCompactProjectionByteTests
{
    ...
    private static readonly TestCaseData[] ProjectionCases =
    {
        ...
        Case("InvariantPoint", "FB4D005773B524F6DDD1214D8C024EFF0B43C540EFFC31ED845BC519BB886ED2", "--position", "0", "--invariant-json"),
        Case("InvariantLine", "C04CB1A4D973263A3FFDA995938F1B42CE655A618E1CDA3DDCF5B450D97D80AC", "--line", "1", "--line-invariants", "--invariant-json"),
        Case("InvariantSpan", "C960C87EEE593CEABFF452E1AEE5FF74F27071B3B76CFE54A41DE4FE6DE74FE3", "--span-start", "0", "--span-end", Source.Length.ToString(), "--invariant-json"),
        Case("InvariantFile", "C3BDC3B8FB192D1C3BAFA890B918B8815010F1EC0B70BC87E833604524554FEF", "--all-lines", "--invariant-json"),
        ...
        Case("InvariantFilteredTruncated", "48DDD5391C0A7F065DE1EF358B5DA71D42E6369E85D9A9812AF88A9830A684BC", "--line", "1", "--line-invariants", "--invariant-json", "--invariant-target", "value", "--max-facts", "0", "--max-conditions", "0", "--max-proofs", "0"),
