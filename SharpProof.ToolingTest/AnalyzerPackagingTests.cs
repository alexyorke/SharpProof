...
";
    ...
    public void SymbolicCli_ShouldExposeBoundedExplainReportFormats()
    {
        AssertSymbolicCliSourceContains(
            ...
            ("SymbolicCliExplainReport.cs", "public int SchemaVersion => 3"),
            ("SymbolicCliExplainReport.cs", "SymbolicQueryResult Invariant"),
            ("SymbolicCliExplainReport.cs", "IReadOnlyList<SymbolicRuntimeHazard> RuntimeHazards"),
    ...
    public void SymbolicCliAndApi_ShouldExposeTypedErrorContract()
    {
        ...
        Assert.That(errorSource, Does.Contain("internal sealed record SymbolicErrorEnvelope"));
    ...
    public void SymbolicCli_ShouldExposeSmtBudgetOptions()
    {
        ...
        Assert.That(source, Does.Contain("Query timeout ms"));
