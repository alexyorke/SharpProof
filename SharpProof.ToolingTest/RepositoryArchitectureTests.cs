...
public sealed class RepositoryArchitectureTests
{
    ...
    public void AnalysisCarriers_UsePrimaryOwnershipInsteadOfCopyConstructors()
    {
        ...
        var carriers = new[]
        {
            ...
            ("SharpProof.Analyzer/Configuration/AnalyzerConfiguration.cs", "record AnalyzerConfiguration("),
            ("SharpProof.Analyzer/Configuration/AnalyzerConfigurationOptionRegistry.cs",
                "record AnalyzerConfigurationOption("),
            ("SharpProof.Analyzer/EffectSummaryArtifactSource.cs", "record EffectSummaryArtifactSource("),
            ("SharpProof.Analyzer/EffectSummaryEntryTrustMetadata.cs", "record EffectSummaryEntryTrustMetadata("),
            ("SharpProof.Analyzer/EffectSummaryMetadataSupport.cs", "record SummaryAssemblyIdentity("),
            ("SharpProof.Analyzer/EffectSummaryMetadataSupport.cs", "record SummaryMethodIdentity("),
            ("SharpProof.Analyzer/EffectSummaryMetadataSupport.cs", "record ActualAssemblyIdentity("),
            ("SharpProof.Analyzer/ExceptionFlowQuery.Models.cs", "record ExceptionFlowSite("),
            ("SharpProof.Analyzer/ExceptionFlowQuery.Models.cs", "record ExceptionFlowEdge("),
            ("SharpProof.Symbolic/SymbolicSourceInput.cs", "record SymbolicSourceInput("),
            ("SharpProof.Symbolic/SymbolicProjectQueryContext.cs", "record SymbolicProjectConfiguration("),
