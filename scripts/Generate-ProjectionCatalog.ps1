...
foreach ($output in @(Required $catalog 'outputs' 'Projection catalog')) {
    ...
    $lines.Add('// Generated by scripts/Generate-ProjectionCatalog.ps1 from')
    $lines.Add('// SharpProof.Projection.catalog.json.')
    $lines.Add('// Declarative projection tables only; analysis remains handwritten.')
