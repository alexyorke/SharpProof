...
if ([string]::IsNullOrWhiteSpace($CatalogPath)) {
    $CatalogPath = Join-Path $repositoryRoot 'SharpProof.Analyzer\AnalyzerDiagnostic.catalog.json'
}
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $OutputPath = Join-Path $repositoryRoot 'SharpProof.Analyzer\AnalyzerDiagnosticCatalog.generated.cs'
}
...
$lines.Add('// SharpProof.Analyzer/AnalyzerDiagnostic.catalog.json.')
