...
if ([string]::IsNullOrWhiteSpace($CatalogPath)) {
    $CatalogPath = Join-Path $repositoryRoot 'SharpProof.Effects\EffectContractMappings.catalog.json'
}
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $OutputPath = Join-Path $repositoryRoot 'SharpProof.Effects\EffectContractMappings.generated.cs'
}
...
$lines.Add('// Generated by scripts/Generate-EffectContractMappings.ps1 from')
$lines.Add('// SharpProof.Effects/EffectContractMappings.catalog.json.')
