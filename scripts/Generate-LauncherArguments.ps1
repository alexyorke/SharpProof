...
$buildTaskLines = [Collections.Generic.List[string]]::new()
$buildTaskLines.Add('// <auto-generated>')
$buildTaskLines.Add('// Generated by scripts/Generate-LauncherArguments.ps1 from')
$buildTaskLines.Add('// SharpProof.Worker.Launcher/LauncherArguments.catalog.json.')
$buildTaskLines.Add('// Do not edit this file directly.')
$buildTaskLines.Add('// </auto-generated>')
$buildTaskLines.Add('#nullable enable')
$buildTaskLines.Add('')
