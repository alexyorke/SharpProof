...
direct clause. Misplaced direct clauses still produce SP0024 and prevent a
companion from binding for that member. Their complete compiler-elided
invocation, including argument evaluation, is omitted from verifier body
execution.
