...
SP0032 | Configuration | Warning | Reports malformed, empty, unsupported, partially ignored, or stale SharpProof analyzer AdditionalFiles, for supported baseline and analyzer inputs.
...
SP0040 | Review | Info | Opt-in structured report for applied and overridden effect contracts, including exact symbol, source, value, and override disposition.
