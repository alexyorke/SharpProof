    ...
    internal static partial class ExceptionFlowAnalyzer
    {
            ...
            DiagnosticBaseline baseline)
        {
            ...
            var validContracts = ReportAndFilterInvalidExceptionContracts(
                ...
                methodSymbol,
                baseline);
            if (validContracts.Length == 0 || queryResult == null)
            {
                return;
            }
            ...
            out string? invalidReason)
        {
            ...
            foreach (var value in values)
            {
                ...
                if (!ContainsSymbol(builder, allowedType))
                {
                    builder.Add(allowedType);
                }
            }
        ...
        {
            if (contract.Kind == ExceptionContractKind.DoesNotThrow)
            {
                return false;
            }
        ...
        {
            return symbols.Any(symbol => SymbolEqualityComparer.Default.Equals(symbol.OriginalDefinition, candidate.OriginalDefinition));
        }
