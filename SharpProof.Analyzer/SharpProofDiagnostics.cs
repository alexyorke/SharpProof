...
public static class SharpProofDiagnostics
{
    ...
    public static readonly DiagnosticDescriptor AwaitNullConditionalRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor TaskConvertedToStringRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor TaskCompletionSourceContinuationsRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor AsyncVoidRule = CreateDescriptor(
        AsyncVoidId,
    ...
    public static readonly DiagnosticDescriptor BlockingAsyncRule = CreateDescriptor(
        BlockingAsyncId,
    ...
    public static readonly DiagnosticDescriptor NullTaskReturnRule = CreateDescriptor(
        NullTaskReturnId,
    ...
    public static readonly DiagnosticDescriptor TaskUsedAsDisposableRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor AsyncValidationDeferredRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor CollectionMutationDuringEnumerationRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor CapturedLoopVariableRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor MutableStructRule = CreateDescriptor(
        MutableStructId,
    ...
    public static readonly DiagnosticDescriptor OwnedDisposableFieldRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor HttpClientInLoopRule = CreateDescriptor(
        HttpClientInLoopId,
    ...
    public static readonly DiagnosticDescriptor UnsynchronizedSharedMutationRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor ConcurrentCollectionEnumerationRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor BoxingInLoopRule = CreateDescriptor(
        BoxingInLoopId,
    ...
    public static readonly DiagnosticDescriptor MaybeNullResultDereferenceRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor PrematureQueryMaterializationRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor DeferredQuerySideEffectRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor QueryTranslationRiskRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor SerializationCycleRiskRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor SerializerAttributeMismatchRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor IneffectiveRequiredAttributeRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor UncheckedAllocationArithmeticRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor SuppressionWithoutJustificationRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor NullableAnalysisDisabledRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor IdenticalOperandsRule = CreateDescriptor(
        IdenticalOperandsId,
    ...
    public static readonly DiagnosticDescriptor ContainerOwnedServiceDisposedRule = CreateDescriptor(
    ...
    public static readonly DiagnosticDescriptor UnconsumedDeferredQueryRule = CreateDescriptor(
    ...
    {
        // The common-bug catalog is additive and profile-enabled so upgrading the
        // analyzer does not inject unrelated diagnostics into existing projects.
        if (string.CompareOrdinal(id, AwaitNullConditionalId) >= 0 &&
            string.CompareOrdinal(id, UnconsumedDeferredQueryId) <= 0)
