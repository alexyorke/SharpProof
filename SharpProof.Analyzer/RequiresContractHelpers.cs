...
namespace SharpProof.Analyzer
{
    internal static class RequiresContractHelpers
    {
            ...
            out string failureReason)
        {
            ...
            if (!TryCreateSpeculativeConditionModel(semanticModel, position, conditionStatement, out conditionSemanticModel))
            {
                formula = null!;
        ...
        internal static int GetMethodEntrySpeculativePosition(SyntaxNode methodNode)
        {
            return methodNode switch
            {
                ...
                ConversionOperatorDeclarationSyntax { ExpressionBody: { } expressionBody } => expressionBody.Expression.SpanStart,
        ...
        internal static string CombineAsImplication(
            ...
            string consequent)
        {
            if (requiresContracts.IsDefaultOrEmpty)
            {
                return consequent;
            }
