...
internal static class AnalyzerSyntaxHelpers {
    ...
    internal static Location GetCallableDeclarationLocation(SyntaxNode node) => node switch {
    ...
    internal static Location GetCallableDeclarationLocation(IMethodSymbol methodSymbol, CancellationToken cancellationToken) {
    ...
    internal static bool HasResultValue(IMethodSymbol methodSymbol)
        => methodSymbol.MethodKind is not (MethodKind.Constructor or MethodKind.StaticConstructor) &&
               !methodSymbol.ReturnsVoid;
    internal static bool IsCompilerMarkedUnreachable(SyntaxNode syntax, SemanticModel semanticModel,
        CancellationToken cancellationToken) => semanticModel.GetDiagnostics(syntax.Span, cancellationToken)
