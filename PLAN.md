...
- Production inventory currently reports 108,300 C# production lines across
  167 files. The largest modules are `PurelySharp.Symbolic` at 49,555 lines,
...
- The largest remaining migration hotspot is `SymbolicProgramPointFacts.cs`,
  now at 8,788 lines. It routes legacy translation through
