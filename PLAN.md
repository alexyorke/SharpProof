...
- Production inventory currently reports 109,511 C# production lines across
  168 files. The largest modules are `PurelySharp.Symbolic` at 50,766 lines,
...
- Direct `CSharpConditionToFormula` usage outside approved shims is gone.
  ...
  currently reports 0 analyzer-side and 30 symbolic-side
