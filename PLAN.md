...
- Production inventory currently reports 112,023 C# production lines across
  179 files. The largest modules are `PurelySharp.Symbolic` at 53,278 lines,
...
- Nullable term lowering now lives in `SymbolicIrLowerer.Nullable.cs`, reducing
  ...
  API dispatch now lives in `SymbolicIrLowerer.KnownApis.cs`;
  `SymbolicIrLowerer.cs` is about 367 lines.
