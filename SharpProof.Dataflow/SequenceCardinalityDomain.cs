...
public sealed class SequenceCardinalityDomain : ClosedAbstractDomain<SequenceCardinalityValue> {
    ...
    public SequenceCardinalityValue Empty { get; }
    public SequenceCardinalityValue NonEmpty { get; }
    public override SequenceCardinalityValue Top { get; }
    ...
    public SequenceCardinalityValue Create(SequenceCardinalityKind kind, IntervalValue length) {
        ...
        if (restricted.IsBottom) return Bottom;
        switch (kind) {
