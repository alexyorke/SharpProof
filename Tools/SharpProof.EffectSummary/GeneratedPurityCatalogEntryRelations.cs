internal static class GeneratedPurityCatalogEntryRelations {
    public static bool AreEquivalent(
        ...
        GeneratedPurityCatalogEntry right) => HaveSameClassification(left, right) &&
    ...
    public static bool DoesDominate(
        ...
        GeneratedPurityCatalogEntry weaker) => HaveSameClassification(stronger, weaker) &&
    ...
    private static bool HaveSameClassification(
        GeneratedPurityCatalogEntry left,
        GeneratedPurityCatalogEntry right) => string.Equals(left.Classification, right.Classification, StringComparison.Ordinal) &&
    ...
    private static bool HaveSameSet(string[] left, string[] right) => left.Length == right.Length &&
