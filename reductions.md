...
| R253 | Rename the documentation validator to `Test-SharpProofReadme.ps1` and remove its output-only `-Verify` switch | Documentation validator; DocumentationSupportContractTests: 23; ContainedPathAuthorityTests: 1; `test-changed` pending |
