...
For source methods in the same compilation, propagation follows the call graph recursively until it reaches the throw origin or a cycle. Metadata/library effect-summary ingestion is currently outside the active repo development flow.
