...
The list currently has 71 entries: 13 P0, 14 P1, 15 P2 and 29 P3. The final
section records the areas that were probed without finding a defect.

## P0 - Critical

The remaining effect-analysis entries in this section also affect verification builds,
not only analyzer diagnostics. The compiler collector uses the same effect summaries
as effect-claim evidence; each remaining entry has a concrete reproduction and
regression plan.
