...
- **Proposed fix:** walk the member type recursively (array element types,
  ...
  simple name, consistent with the exact-type classification used by
  SPMETA010.
