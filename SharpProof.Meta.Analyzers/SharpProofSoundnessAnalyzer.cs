...
public sealed class SharpProofSoundnessAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(startContext =>
        {
            ...
            startContext.RegisterOperationAction(AnalyzeCacheAssignment, OperationKind.SimpleAssignment);
    ...
    private static void AnalyzeCacheAssignment(OperationAnalysisContext context)
    {
        ...
        Report(context, MetaDiagnosticDescriptors.NonCacheableSemanticAnswer,
        ...
        return operation switch
        {
            IFieldReferenceOperation field
                when field.Field.ContainingType.TypeKind == TypeKind.Enum &&
                     IsSemanticAnswerType(field.Type) =>
        ...
        HashSet<ILocalSymbol> resolving)
    {
        ...
        try
        {
            ...
            {
                return IsNonCacheableSemanticAnswer(
