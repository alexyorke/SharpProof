...
internal static class SymbolicIrVersionRewriter
{
        ...
        ImmutableDictionary<string, int> symbolVersions)
    {
        ...
        if (symbolVersions.IsEmpty) return term;
        ...
        return term switch
        {
            ...
            SymbolicNullableHasValueTerm nullableHasValue => RewriteNullableHasValueTerm(nullableHasValue,
                symbolVersions),
        ...
        ImmutableDictionary<string, int> symbolVersions)
    {
        ...
        if (symbolVersions.IsEmpty) return condition;
        ...
        ImmutableDictionary<string, int> symbolVersions)
    {
        ...
        if (symbolVersions.IsEmpty) return fact;
