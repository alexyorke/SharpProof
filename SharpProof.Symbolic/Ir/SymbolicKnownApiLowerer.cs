...
internal static class SymbolicKnownApiLowerer {
    ...
    private static readonly ImmutableArray<KnownApiLoweringDescriptor<SymbolicCondition>> KnownApiLowerings =
        [
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_Object, nameof(ReferenceEquals),
                SymbolicObjectLowerer.TryLowerObjectReferenceEqualsInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.Contains),
                SymbolicStringLowerer.TryLowerStringPredicateInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.StartsWith),
                SymbolicStringLowerer.TryLowerStringPredicateInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.EndsWith),
                SymbolicStringLowerer.TryLowerStringPredicateInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.IsNullOrEmpty),
                SymbolicStringLowerer.TryLowerStringNullOrPredicateInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.IsNullOrWhiteSpace),
                SymbolicStringLowerer.TryLowerStringNullOrPredicateInvocation),
            new KnownApiLoweringDescriptor<SymbolicCondition>(SpecialType.System_String, nameof(string.Equals),
