...
namespace SharpProof.Symbolic
{
    internal static class SymbolicKnownGuardFacts
    {
            ...
            out string guardKey)
        {
            ...
            if (semanticModel.GetOperation(invocation, cancellationToken) is not IInvocationOperation operation ||
                ...
                !TryGetGuardRelations(
                    ...
                    out guardKey) ||
                !TryGetArgumentExpression(operation, parameterOrdinal: 0, out var subjectExpression))
            {
                return false;
            }
            ...
            {
                if (!TryGetArgumentExpression(operation, parameterOrdinal: 1, out var comparisonExpression) ||
            ...
            out string guardKey)
        {
            ...
            {
                "ThrowIfNegative" => (SymbolicRelationOperator.LessThan, SymbolicRelationOperator.GreaterThanOrEqual, false, "negative"),
                "ThrowIfZero" => (SymbolicRelationOperator.Equal, SymbolicRelationOperator.NotEqual, false, "zero"),
                "ThrowIfNegativeOrZero" => (SymbolicRelationOperator.LessThanOrEqual, SymbolicRelationOperator.GreaterThan, false, "negative-or-zero"),
                "ThrowIfLessThan" => (SymbolicRelationOperator.LessThan, SymbolicRelationOperator.GreaterThanOrEqual, true, "less-than"),
                "ThrowIfLessThanOrEqual" => (SymbolicRelationOperator.LessThanOrEqual, SymbolicRelationOperator.GreaterThan, true, "less-than-or-equal"),
                "ThrowIfGreaterThan" => (SymbolicRelationOperator.GreaterThan, SymbolicRelationOperator.LessThanOrEqual, true, "greater-than"),
                "ThrowIfGreaterThanOrEqual" => (SymbolicRelationOperator.GreaterThanOrEqual, SymbolicRelationOperator.LessThan, true, "greater-than-or-equal"),
                _ => default,
            };
