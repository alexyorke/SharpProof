    ...
    private sealed class EffectFlowDomain(
        ...
        private EffectFlowValue EvaluateProperty(IPropertyReferenceOperation property, ref EffectFlowState state) {
            ...
            if (property.Property.IsStatic) {
                if (!KnownEffectCatalog.IsStatelessEmptyViewProperty(property.Property))
        ...
        private EffectFlowValue InvokeCore(
            ...
            var boundCall = BoundCall.Create(target);
            values = boundCall.BindFormal(receiver, values);
            target = boundCall.Method;
            ...
            ApplyRefArguments(summary, target, arguments, receiver, values, ref state, boundCall.FormalOffset);
        ...
        private CompilerMethodEffectSummary GetSummary(
            ...
            if (syntax == null) {
                ...
                if (KnownEffectCatalog.TryGetEffect(target, out var known))
                    return new(known.Summary, FrameworkReturn(target),
                        ...
                        known.WrittenArgumentOrdinals, known.ReadArgumentOrdinals);
