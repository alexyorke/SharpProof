...
internal sealed class MethodEffectAnalysisSession(
    ...
    private sealed class EffectFlowDomain(
        ...
        private static bool IsMemoryMarshalTryWrite(IMethodSymbol method) =>
            ...
            SymbolEqualityComparer.Default.Equals(method.Parameters[1].Type, method.TypeArguments[0]);
        private static bool IsMemoryMarshalWrite(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Write",
                IsStatic: true,
        ...
        private static bool IsArrayGetLongLength(IMethodSymbol method) =>
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsArrayGetLowerBound(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetLowerBound",
                IsStatic: false,
        ...
        private static bool IsSingleLengthArrayCreateInstance(IMethodSymbol method) =>
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsLengthsArrayCreateInstance(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "CreateInstance",
                IsStatic: true,
        ...
        private static bool IsTwoScalarLengthsArrayCreateInstance(IMethodSymbol method) =>
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 } &&
            method.Parameters[2] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsThreeScalarLengthsArrayCreateInstance(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "CreateInstance",
                IsStatic: true,
        ...
        private static bool IsThreeIndexArraySetValue(IMethodSymbol method) =>
            ...
            method.Parameters[2] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 } &&
            method.Parameters[3] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsIndexesArraySetValue(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "SetValue",
                IsStatic: false,
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Object } &&
            method.Parameters[1] is { RefKind: RefKind.None, Type: IArrayTypeSymbol indexesType } &&
            indexesType.ElementType.SpecialType == SpecialType.System_Int32;
        ...
        private static bool IsArrayConstrainedCopy(IMethodSymbol method) =>
            ...
            method.Parameters[3] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 } &&
            method.Parameters[4] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBufferBlockCopy(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "BlockCopy",
                IsStatic: true,
            ...
            method.Parameters[3] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 } &&
            method.Parameters[4] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBufferByteLength(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ByteLength",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Buffer" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Array };
        private static bool IsBufferGetByte(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetByte",
                IsStatic: true,
        ...
        private static bool IsBitConverterToInt32Array(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToInt32",
                IsStatic: true,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToInt32Span(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToInt32",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToInt64Array(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToInt64",
                IsStatic: true,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToInt64Span(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToInt64",
                IsStatic: true,
        ...
        private static bool IsBitConverterToInt16Array(IMethodSymbol method) =>
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToInt16Span(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToInt16",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToUInt16Array(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToUInt16",
                IsStatic: true,
                Parameters.Length: 2,
                ReturnType.SpecialType: SpecialType.System_UInt16
            } &&
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is {
                RefKind: RefKind.None,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToUInt16Span(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToUInt16",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToUInt32Array(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToUInt32",
                IsStatic: true,
        ...
        private static bool IsBitConverterToUInt64Array(IMethodSymbol method) =>
            method is {
                ...
                IsStatic: true,
                Parameters.Length: 2,
                ReturnType.SpecialType: SpecialType.System_UInt64
            } &&
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is {
                RefKind: RefKind.None,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToUInt64Span(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToUInt64",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToBooleanArray(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToBoolean",
                IsStatic: true,
        ...
        private static bool IsBitConverterToCharArray(IMethodSymbol method) =>
            method is {
                ...
                IsStatic: true,
                Parameters.Length: 2,
                ReturnType.SpecialType: SpecialType.System_Char
            } &&
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is {
                RefKind: RefKind.None,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToCharSpan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToChar",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToSingleArray(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToSingle",
                IsStatic: true,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToSingleSpan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToSingle",
                IsStatic: true,
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToDoubleArray(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToDouble",
                IsStatic: true,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterToDoubleSpan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToDouble",
                IsStatic: true,
        ...
        private static bool IsBitConverterToHalfSpan(IMethodSymbol method) =>
            ...
            sourceType.OriginalDefinition.ToDisplayString() == "System.ReadOnlySpan<T>" &&
            sourceType.TypeArguments[0].SpecialType == SpecialType.System_Byte;
        private static bool IsBitConverterToHalfArray(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToHalf",
                IsStatic: true,
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterDoubleToInt64Bits(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
        ...
        private static bool IsBitConverterDoubleToUInt64Bits(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "DoubleToUInt64Bits",
                IsStatic: true,
                Parameters.Length: 1,
                ReturnType.SpecialType: SpecialType.System_UInt64
            } &&
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsBitConverterInt64BitsToDouble(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int64 };
        private static bool IsBitConverterUInt64BitsToDouble(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
        ...
        private static bool IsBitConverterSingleToInt32Bits(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
        ...
        private static bool IsBitConverterSingleToUInt32Bits(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "SingleToUInt32Bits",
                IsStatic: true,
                Parameters.Length: 1,
                ReturnType.SpecialType: SpecialType.System_UInt32
            } &&
        ...
        private static bool IsBitConverterInt32BitsToSingle(IMethodSymbol method) =>
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterUInt32BitsToSingle(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "UInt32BitsToSingle",
                IsStatic: true,
                Parameters.Length: 1,
                ReturnType.SpecialType: SpecialType.System_Single
            } &&
        ...
        private static bool IsMathBitIncrement(IMethodSymbol method) =>
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathBitDecrement(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "BitDecrement",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFBitIncrement(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "BitIncrement",
                IsStatic: true,
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathFBitDecrement(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "BitDecrement",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathCopySign(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "CopySign",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double } &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFCopySign(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "CopySign",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single } &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathScaleB(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ScaleB",
                IsStatic: true,
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double } &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsMathFScaleB(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ScaleB",
                IsStatic: true,
            ...
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single } &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsMathFusedMultiplyAdd(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
        ...
        private static bool IsMathILogB(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ILogB",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFILogB(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ILogB",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathLog2(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Log2",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFLog2(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Log2",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathCbrt(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Cbrt",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFCbrt(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Cbrt",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathSin(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Sin",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFSin(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Sin",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathCos(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Cos",
                IsStatic: true,
        ...
        private static bool IsMathFCos(IMethodSymbol method) =>
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathTan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Tan",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFTan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Tan",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathAsin(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Asin",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFAsin(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Asin",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathAcos(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Acos",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFAcos(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Acos",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathAtan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Atan",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.Math" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsMathFAtan(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Atan",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.MathF" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsMathAtan2(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "Atan2",
                IsStatic: true,
        ...
        private static bool IsBitConverterToStringArrayFromOffset(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "ToString",
                IsStatic: true,
        ...
        private static bool IsBitConverterToStringArrayRange(IMethodSymbol method) =>
            ...
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 } &&
            method.Parameters[2] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterGetBytesInt32(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterGetBytesInt64(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int64 };
        private static bool IsBitConverterGetBytesBoolean(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
        ...
        private static bool IsBitConverterGetBytesSingle(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsBitConverterGetBytesDouble(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsBitConverterGetBytesInt16(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int16 };
        private static bool IsBitConverterGetBytesUInt16(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_UInt16 };
        private static bool IsBitConverterGetBytesUInt32(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
            ...
            method.ContainingType.ToDisplayString() == "System.BitConverter" &&
            method.Parameters[0] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_UInt32 };
        private static bool IsBitConverterGetBytesUInt64(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "GetBytes",
                IsStatic: true,
        ...
        private static bool IsBitConverterTryWriteBytesInt32(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int32 };
        private static bool IsBitConverterTryWriteBytesInt64(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int64 };
        private static bool IsBitConverterTryWriteBytesBoolean(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.OriginalDefinition.ToDisplayString() == "System.Span<T>" &&
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Boolean };
        private static bool IsBitConverterTryWriteBytesChar(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.OriginalDefinition.ToDisplayString() == "System.Span<T>" &&
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Char };
        private static bool IsBitConverterTryWriteBytesSingle(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Single };
        private static bool IsBitConverterTryWriteBytesDouble(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Double };
        private static bool IsBitConverterTryWriteBytesInt16(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.OriginalDefinition.ToDisplayString() == "System.Span<T>" &&
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_Int16 };
        private static bool IsBitConverterTryWriteBytesUInt16(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.OriginalDefinition.ToDisplayString() == "System.Span<T>" &&
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1] is { RefKind: RefKind.None, Type.SpecialType: SpecialType.System_UInt16 };
        private static bool IsBitConverterTryWriteBytesUInt32(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
        ...
        private static bool IsBitConverterTryWriteBytesHalf(IMethodSymbol method) =>
            method is {
                MethodKind: MethodKind.Ordinary,
                Name: "TryWriteBytes",
                IsStatic: true,
            ...
            destinationType.TypeArguments[0].SpecialType == SpecialType.System_Byte &&
            method.Parameters[1].RefKind == RefKind.None &&
            method.Parameters[1].Type.ToDisplayString() == "System.Half";
        ...
        private static bool TryFrameworkSummary(IMethodSymbol method, out MethodEffects summary) {
            ...
            SharpProofEffect? effects = (definition, method.MethodKind, method.Name) switch {
                ...
                ("System.Threading.Interlocked", MethodKind.Ordinary, "Exchange" or "Add")
                    ...
                    SharpProofEffect.None,
                ("System.Threading.Interlocked", MethodKind.Ordinary, "CompareExchange")
                    when method.Parameters.Length == 3 &&
                         method.Parameters[0].RefKind == RefKind.Ref &&
                         method.Parameters[0].Type.SpecialType is
                             SpecialType.System_Int32 or SpecialType.System_Int64 &&
                         method.Parameters[1].Type.SpecialType == method.Parameters[0].Type.SpecialType &&
                ...
                ("System.Array", MethodKind.Ordinary, "SetValue")
                    when IsIndexesArraySetValue(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesReceiverState | SharpProofEffect.Throws,
                ("System.Array", MethodKind.Ordinary, "SetValue")
                ...
                ("System.Array", MethodKind.Ordinary, "ConstrainedCopy")
                    ...
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState | SharpProofEffect.Throws,
                ("System.Buffer", MethodKind.Ordinary, "BlockCopy")
                    when IsBufferBlockCopy(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState | SharpProofEffect.Throws,
                ("System.Buffer", MethodKind.Ordinary, "ByteLength")
                    when IsBufferByteLength(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ...
                ("System.Buffer", MethodKind.Ordinary, "MemoryCopy")
                    ...
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.WritesArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt32")
                    when IsBitConverterToInt32Array(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt32")
                    when IsBitConverterToInt32Span(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt64")
                    when IsBitConverterToInt64Array(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt64")
                    when IsBitConverterToInt64Span(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt16")
                    when IsBitConverterToInt16Array(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToInt16")
                    when IsBitConverterToInt16Span(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToUInt16")
                    when IsBitConverterToUInt16Array(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToUInt16")
                    when IsBitConverterToUInt16Span(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ...
                ("System.BitConverter", MethodKind.Ordinary, "ToUInt64")
                    ...
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToUInt64")
                    when IsBitConverterToUInt64Span(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ...
                ("System.BitConverter", MethodKind.Ordinary, "ToChar")
                    ...
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToChar")
                    when IsBitConverterToCharSpan(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToSingle")
                    when IsBitConverterToSingleArray(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToSingle")
                    when IsBitConverterToSingleSpan(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToDouble")
                    when IsBitConverterToDoubleArray(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToDouble")
                ...
                ("System.BitConverter", MethodKind.Ordinary, "ToHalf")
                    ...
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "ToHalf")
                    when IsBitConverterToHalfArray(method) =>
                    SharpProofEffect.ReadsArgumentState | SharpProofEffect.Throws,
                ("System.BitConverter", MethodKind.Ordinary, "DoubleToInt64Bits")
                    when IsBitConverterDoubleToInt64Bits(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "DoubleToUInt64Bits")
                    when IsBitConverterDoubleToUInt64Bits(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "Int64BitsToDouble")
                    when IsBitConverterInt64BitsToDouble(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "UInt64BitsToDouble")
                    when IsBitConverterUInt64BitsToDouble(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "SingleToInt32Bits")
                    when IsBitConverterSingleToInt32Bits(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "SingleToUInt32Bits")
                    when IsBitConverterSingleToUInt32Bits(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "Int32BitsToSingle")
                    when IsBitConverterInt32BitsToSingle(method) =>
                    SharpProofEffect.None,
                ("System.BitConverter", MethodKind.Ordinary, "UInt32BitsToSingle")
                    when IsBitConverterUInt32BitsToSingle(method) =>
                    SharpProofEffect.None,
                ...
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesInt32(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesInt64(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                ...
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    ...
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesSingle(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesDouble(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesInt16(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesUInt16(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                    when IsBitConverterGetBytesUInt32(method) =>
                    SharpProofEffect.Allocates,
                ("System.BitConverter", MethodKind.Ordinary, "GetBytes")
                ...
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesInt32(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesInt64(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesBoolean(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesChar(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesSingle(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesDouble(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesInt16(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                    when IsBitConverterTryWriteBytesUInt16(method) =>
                    SharpProofEffect.WritesArgumentState,
                ("System.BitConverter", MethodKind.Ordinary, "TryWriteBytes")
                ...
                ("System.Math", MethodKind.Ordinary, "BitIncrement")
                    ...
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "BitDecrement")
                    when IsMathBitDecrement(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "BitIncrement")
                    when IsMathFBitIncrement(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "BitDecrement")
                    when IsMathFBitDecrement(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "CopySign")
                    when IsMathCopySign(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "CopySign")
                    when IsMathFCopySign(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "ScaleB")
                    when IsMathScaleB(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "ScaleB")
                    when IsMathFScaleB(method) =>
                    SharpProofEffect.None,
                ...
                ("System.MathF", MethodKind.Ordinary, "FusedMultiplyAdd")
                    ...
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "ILogB")
                    when IsMathILogB(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "ILogB")
                    when IsMathFILogB(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Log2")
                    when IsMathLog2(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Log2")
                    when IsMathFLog2(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Cbrt")
                    when IsMathCbrt(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Cbrt")
                    when IsMathFCbrt(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Sin")
                    when IsMathSin(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Sin")
                    when IsMathFSin(method) =>
                    SharpProofEffect.None,
                ...
                ("System.MathF", MethodKind.Ordinary, "Cos")
                    ...
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Tan")
                    when IsMathTan(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Tan")
                    when IsMathFTan(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Asin")
                    when IsMathAsin(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Asin")
                    when IsMathFAsin(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Acos")
                    when IsMathAcos(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Acos")
                    when IsMathFAcos(method) =>
                    SharpProofEffect.None,
                ("System.Math", MethodKind.Ordinary, "Atan")
                    when IsMathAtan(method) =>
                    SharpProofEffect.None,
                ("System.MathF", MethodKind.Ordinary, "Atan")
                    when IsMathFAtan(method) =>
                    SharpProofEffect.None,
            ...
            var isMemoryMarshalWrite = IsMemoryMarshalWrite(method);
            var memoryMarshalAccessReason = isMemoryMarshalWrite
                ? "framework_memory_marshal_write_model"
                : "framework_memory_marshal_read_model";
            ImmutableArray<MethodExceptionFact> exceptions = IsMemoryMarshalRead(method) || isMemoryMarshalWrite
                ? [
                ...
                : IsArrayDimensionQuery(method)
                    ? [
                        MethodExceptionFact.Boundary("System.IndexOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_array_get_length_model")
                    ]
                : IsArrayCreateInstance(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                ...
                : IsBufferBlockCopy(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_buffer_block_copy_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_buffer_block_copy_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_buffer_block_copy_model")
                    ]
                : IsBufferByteLength(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_buffer_byte_length_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_buffer_byte_length_model")
                    ]
                : IsBufferGetByte(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                ...
                : IsBitConverterToInt32Array(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int32_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int32_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int32_array_model")
                    ]
                : IsBitConverterToInt32Span(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int32_span_model")
                    ]
                : IsBitConverterToInt64Array(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                ...
                : IsBitConverterToInt64Span(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int64_span_model")
                    ]
                ...
                : IsBitConverterToInt16Span(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_int16_span_model")
                    ]
                : IsBitConverterToUInt16Array(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint16_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint16_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint16_array_model")
                    ]
                : IsBitConverterToUInt16Span(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint16_span_model")
                    ]
                : IsBitConverterToUInt32Array(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                ...
                : IsBitConverterToUInt64Array(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint64_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint64_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint64_array_model")
                    ]
                : IsBitConverterToUInt64Span(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_uint64_span_model")
                    ]
                : IsBitConverterToBooleanArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                ...
                : IsBitConverterToCharArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_char_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_char_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_char_array_model")
                    ]
                : IsBitConverterToCharSpan(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_char_span_model")
                    ]
                : IsBitConverterToSingleArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_single_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_single_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_single_array_model")
                    ]
                : IsBitConverterToSingleSpan(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_single_span_model")
                    ]
                : IsBitConverterToDoubleArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_double_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_double_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_double_array_model")
                    ]
                : IsBitConverterToDoubleSpan(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                ...
                : IsBitConverterToHalfArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_half_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentOutOfRangeException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_half_array_model"),
                        MethodExceptionFact.Boundary("System.ArgumentException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_half_array_model")
                ...
                : IsBitConverterToStringArray(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
                            "framework_bit_converter_to_string_array_model")
                    ]
                : IsBitConverterToStringArrayFromOffset(method)
                    ? [
                        MethodExceptionFact.Boundary("System.ArgumentNullException", MethodExceptionSource.Contract,
        ...
        private static ImmutableArray<int> FrameworkWrittenArgumentOrdinals(IMethodSymbol method) {
            ...
            if (IsBitConverterTryWriteBytesInt32(method)) return [0];
            if (IsBitConverterTryWriteBytesInt64(method)) return [0];
            if (IsBitConverterTryWriteBytesBoolean(method)) return [0];
            if (IsBitConverterTryWriteBytesChar(method)) return [0];
            if (IsBitConverterTryWriteBytesSingle(method)) return [0];
            if (IsBitConverterTryWriteBytesDouble(method)) return [0];
            ...
            if (IsBitConverterTryWriteBytesHalf(method)) return [0];
        ...
        private static ImmutableArray<int> FrameworkReadArgumentOrdinals(IMethodSymbol method) {
            ...
            if (IsBitConverterToUInt16Array(method)) return [0];
            if (IsBitConverterToUInt32Array(method)) return [0];
            if (IsBitConverterToUInt64Array(method)) return [0];
            if (IsBitConverterToBooleanArray(method)) return [0];
            if (IsBitConverterToCharArray(method)) return [0];
            if (IsBitConverterToSingleArray(method)) return [0];
            ...
            if (IsBitConverterToInt32Span(method)) return [0];
            ...
            if (IsBitConverterToHalfArray(method)) return [0];
            return IsMemoryMarshalTryRead(method) || IsMemoryMarshalRead(method) ||
                   ...
                   IsBufferByteLength(method) || IsBufferGetByte(method) ||
