...
internal sealed partial class SymbolicQueryExecutor {
    ...
    public SymbolicQueryResult Query(SymbolicQueryContext context, CancellationToken cancellationToken = default)
        => ExecuteWithLimits(context, cancellationToken, QuerySource);
    public SymbolicConditionProofResult Prove(
        ...
        return ExecuteWithLimits(context, cancellationToken, (request, token) => ProveSource(request, conditionText, token));
    }
    ...
    public SymbolicComplexityResult QueryComplexity(SymbolicQueryContext context, CancellationToken cancellationToken = default)
        => ExecuteWithLimits(context, cancellationToken, (request, token) =>
