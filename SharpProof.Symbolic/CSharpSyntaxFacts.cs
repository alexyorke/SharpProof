...
internal static class CSharpSyntaxFacts {
    ...
    public static bool IsCallableBoundary(SyntaxNode node) => node is MethodDeclarationSyntax or
    ...
    public static BlockSyntax? GetBlockBody(SyntaxNode node) => node switch {
    ...
    public static bool IsThrowOnlyStatement(StatementSyntax statement) => statement is ThrowStatementSyntax ||
    ...
    internal static bool TryGetIncrementOrDecrementOperand(ExpressionSyntax expression, out ExpressionSyntax operand, out int delta) {
